...
function t(r, n, o, i, s, l) {
	if (i <= o) return;
	const a = (function (t, r, n, o, i) {
		const s = t[i];
		e(t, o, i);
		let l = n;
		for (let i = n; i < o; ++i) r(t[i], s) < 0 && (e(t, l, i), ++l);
		return (e(t, o, l), l);
	})(r, n, o, i, Math.floor(Math.random() * (i - o)) + o);
	(s < a && t(r, n, o, a - 1, s, l), a < l && t(r, n, a + 1, i, s, l));
}
function r(e, t, r, n) {
	const o = [];
	let i = 0,
	...
	for (; i < e.length && s < t.length; ) {
		const l = r(e[i], t[s]);
		((!n && l) || o.push(l <= 0 ? e[i] : t[s]), l <= 0 && i++, l >= 0 && s++);
	}
	if (n) {
		for (; i < e.length; ) o.push(e[i++]);
		for (; s < t.length; ) o.push(t[s++]);
	}
	return o;
}
function n(e, t, r, n, o) {
	let i = n || 0,
		s = void 0 !== o ? o : e.length;
	for (; i < s; ) {
		const n = (i + s) >> 1;
		r(t, e[n]) > 0 ? (i = n + 1) : (s = n);
	}
...
function o(e, t, r) {
	...
	do {
		((u = o + (i - o) / 2),
			(s = n ? Math.ceil(u) : Math.floor(u)),
			(l = t(e[s])),
			(a = l === n),
			a
				? (o = Math.min(i, s + (o === s ? 1 : 0)))
				: (i = Math.max(o, s + (i === s ? -1 : 0))));
	} while (i !== o);
	return t(e[o]) ? o : null;
}
var i = Object.freeze({
		...
		removeElement: (e, t, r) => {
			let n = e.indexOf(t);
			if (-1 === n) return !1;
			if (r) return (e.splice(n, 1), !0);
			for (let r = n + 1, o = e.length; r < o; ++r)
				e[r] !== t && (e[n++] = e[r]);
			return ((e.length = n), !0);
		},
		sortRange: function (e, r, n, o, i, s) {
			return (
				0 === n && o === e.length - 1 && 0 === i && s >= o
					? e.sort(r)
					: t(e, r, n, o, i, s),
				e
			);
...
var u = Object.freeze({
	...
	rangeOfWord: function (e, t, r, n, o) {
		...
		return (u.setStart(i, l), u.setEnd(s, a), u);
	},
});
const c = new Set(["ArrowUp", "ArrowDown", "ArrowLeft", "ArrowRight"]);
var f = Object.freeze({
	__proto__: null,
	ENTER_KEY: "Enter",
	ESCAPE_KEY: "Escape",
...
class d {
	...
	delete(e, t) {
		...
		if (!r) return !1;
		const n = r.delete(t);
		return (r.size || this.map.delete(e), n);
	}
	deleteAll(e) {
		this.map.delete(e);
	}
	...
	valuesArray() {
		const e = [];
		for (const t of this.map.values()) e.push(...t.values());
		return e;
	}
	clear() {
		this.map.clear();
...
var h = Object.freeze({
	...
	inverse: function (e) {
		const t = new d();
		for (const [r, n] of e.entries()) t.set(n, r);
		return t;
	},
	Multimap: d,
	getWithDefault: function (e, t, r) {
		let n = e.get(t);
		return (n || ((n = r(t)), e.set(t, n)), n);
	},
});
const g = (e, t) => {
		for (e = Math.round(e), t = Math.round(t); 0 !== t; ) {
			const r = t;
			((t = e % t), (e = r));
		}
		return e;
...
var m = Object.freeze({
	...
	clamp: (e, t, r) => {
		let n = e;
		return (e < t ? (n = t) : e > r && (n = r), n);
	},
	mod: (e, t) => ((e % t) + t) % t,
	bytesToString: (e) => {
		if (e < 1e3) return `${e.toFixed(0)} B`;
		const t = e / 1e3;
		if (t < 100) return `${t.toFixed(1)} kB`;
		if (t < 1e3) return `${t.toFixed(0)} kB`;
		const r = t / 1e3;
		return r < 100 ? `${r.toFixed(1)} MB` : `${r.toFixed(0)} MB`;
	},
	toFixedIfFloating: (e) => {
	...
	withThousandsSeparator: function (e) {
		let t = String(e);
		const r = /(\d+)(\d{3})/;
		for (; t.match(r); ) t = t.replace(r, "$1 $2");
		return t;
	},
});
var _ = Object.freeze({
...
const E = (e, t) => {
		...
		for (let r = 0; r < e.length; ++r)
			(-1 !== t.indexOf(e.charAt(r)) && (n += "\\"), (n += e.charAt(r)));
		return n;
	},
	x = (e, t) => e.toString(16).toUpperCase().padStart(t, "0"),
	S = new Map([
		["\b", "\\b"],
		["\f", "\\f"],
		["\n", "\\n"],
	...
	w = (e, t) => {
		const r = [];
		let n = e.indexOf(t);
		for (; -1 !== n; ) (r.push(n), (n = e.indexOf(t, n + t.length)));
		return r;
	},
	N = "^[]{}()\\.^$*+?|-,",
	O = function () {
...
var C = Object.freeze({
		...
		const t = /(\\|<(?:!--|\/?script))|(\p{Control})|(\p{Surrogate})/gu,
			...
			n = (e, t, r, n) => {
				if (r) {
					...
					return "\\x" + x(r.charCodeAt(0), 2);
				}
				if (n) {
					return "\\u" + x(n.charCodeAt(0), 4);
				}
				return t ? S.get(t) || "" : e;
			};
		let o = "",
			...
			e.includes("'")
				? e.includes('"')
					? e.includes("`") || e.includes("${")
						? ((i = "'"), (o = e.replaceAll(r, n)))
						: ((i = "`"), (o = e.replaceAll(t, n)))
					: ((i = '"'), (o = e.replaceAll(t, n)))
				: ((i = "'"), (o = e.replaceAll(t, n))),
			`${i}${o}${i}`
		);
	...
	sprintf: (e, ...t) => {
		...
		return e.replaceAll(/%(?:(\d+)\$)?(?:\.(\d*))?([%dfs])/g, (e, n, o, i) => {
			if ("%" === i) return "%";
			if (void 0 !== n && ((r = parseInt(n, 10) - 1), r < 0))
				throw new RangeError(`Invalid parameter index ${r + 1}`);
			if (r >= t.length)
				throw new RangeError(
					`Expected at least ${r + 1} format parameters, but only ${t.length} where given.`
				);
			if ("s" === i) {
				const e = String(t[r++]);
			...
			return (
				isNaN(s) && (s = 0),
				"d" === i
					? String(Math.floor(s)).padStart(Number(o), "0")
					: void 0 !== o
						? s.toFixed(Number(o))
						: String(s)
			);
	...
	replaceControlCharacters: (e) =>
		e.replace(/[\0-\x08\x0B\f\x0E-\x1F\x80-\x9F]/g, "�"),
	countWtf8Bytes: (e) => {
		let t = 0;
		for (let r = 0; r < e.length; r++) {
	...
	regexSpecialCharacters: O,
	filterRegex: function (e) {
		let t = "^(?:.*\\0)?";
		for (let r = 0; r < e.length; ++r) {
			let n = e.charAt(r);
			(-1 !== N.indexOf(n) && (n = "\\" + n), (t += "[^\\0" + n + "]*" + n));
		}
	...
	hashCode: function (e) {
		...
		return ((r = (r + n * (t - 1)) % t), Math.abs(0 | r));
	},
	compare: (e, t) => (e > t ? 1 : e < t ? -1 : 0),
	trimMiddle: (e, t) => {
		if (e.length <= t) return String(e);
		let r = t >> 1,
			n = t - r - 1;
		return (
			e.codePointAt(e.length - n - 1) >= 65536 && (--n, ++r),
			r > 0 && e.codePointAt(r - 1) >= 65536 && --r,
			e.substr(0, r) + "…" + e.substr(e.length - n, n)
		);
	},
	trimEndWithMaxLength: (e, t) =>
		e.length <= t ? String(e) : e.substr(0, t - 1) + "…",
	escapeForRegExp: (e) => E(e, N),
	...
	countUnmatchedLeftParentheses: (e) => {
		let t = 0;
		for (const r of e) "(" === r ? t++ : ")" === r && t > 0 && t--;
		return t;
	},
	createPlainTextSearchRegex: v,
...
var T = Object.freeze({
	__proto__: null,
	assertNotNullOrUndefined: U,
	assertNever: y,
	assertUnhandled: R,
});
var M = Object.freeze({ __proto__: null, LocalizedEmptyString: "" });
...
export {
	...
	l as DateUtilities,
	a as DevToolsPath,
	f as KeyboardUtilities,
	h as MapUtilities,
	m as NumberUtilities,
	_ as PromiseUtilities,
	b as SetUtilities,
	C as StringUtilities,
	A as Timing,
	T as TypeScriptUtilities,
	M as UIString,
	$ as UserVisibleError,
	y as assertNever,
	U as assertNotNullOrUndefined,
	R as assertUnhandled,
};
