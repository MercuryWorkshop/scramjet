...
import * as i from "../../ui/legacy/components/utils/utils.js";
...
const r = {
	...
	s = a.i18n.registerUIStrings("entrypoints/main/main-meta.ts", r),
	l = a.i18n.getLazilyComputedLocalizedString.bind(void 0, s);
let c, g;
async function d() {
	return (c || (c = await import("./main.js")), c);
}
function u(t) {
	return () =>
		a.i18n.getLocalizedLanguageRegion(
			t,
			a.DevToolsLocale.DevToolsLocale.instance()
		);
}
(n.ActionRegistration.registerActionExtension({
	category: n.ActionRegistration.ActionCategory.DRAWER,
	actionId: "inspector_main.focus-debuggee",
	loadActionDelegate: async () =>
		new (
			await (async function () {
				return (
					g || (g = await import("../inspector_main/inspector_main.js")),
					g
				);
			})()
		).InspectorMain.FocusDebuggeeActionDelegate(),
	order: 100,
	title: l(r.focusDebuggee),
}),
	n.ActionRegistration.registerActionExtension({
		category: n.ActionRegistration.ActionCategory.DRAWER,
		actionId: "main.toggle-drawer",
		loadActionDelegate: async () => new n.InspectorView.ActionDelegate(),
		order: 101,
		title: l(r.toggleDrawer),
		bindings: [{ shortcut: "Esc" }],
	}),
	n.ActionRegistration.registerActionExtension({
		actionId: "main.next-tab",
		category: n.ActionRegistration.ActionCategory.GLOBAL,
		title: l(r.nextPanel),
		loadActionDelegate: async () => new n.InspectorView.ActionDelegate(),
		bindings: [
	...
	n.ActionRegistration.registerActionExtension({
		...
		category: n.ActionRegistration.ActionCategory.GLOBAL,
		title: l(r.reloadDevtools),
		loadActionDelegate: async () =>
			new (await d()).MainImpl.ReloadActionDelegate(),
		bindings: [{ shortcut: "Alt+R" }],
	}),
	n.ActionRegistration.registerActionExtension({
		category: n.ActionRegistration.ActionCategory.GLOBAL,
		title: l(r.restoreLastDockPosition),
		actionId: "main.toggle-dock",
		loadActionDelegate: async () =>
			new n.DockController.ToggleDockActionDelegate(),
		bindings: [
	...
	n.ActionRegistration.registerActionExtension({
		...
		title: l(r.zoomIn),
		loadActionDelegate: async () =>
			new (await d()).MainImpl.ZoomActionDelegate(),
		bindings: [
			{
	...
	n.ActionRegistration.registerActionExtension({
		...
		category: n.ActionRegistration.ActionCategory.GLOBAL,
		title: l(r.searchInPanel),
		loadActionDelegate: async () =>
			new (await d()).MainImpl.SearchActionDelegate(),
		bindings: [
			{
				platform: "windows,linux",
				shortcut: "Ctrl+F",
	...
	t.Settings.registerSettingExtension({
		...
		options: [
			{
				title: l(r.switchToSystemPreferredColor),
				text: l(r.systemPreference),
				value: "systemPreferred",
			},
			{
				title: l(r.switchToLightTheme),
				text: l(r.lightCapital),
				value: "default",
			},
			{ title: l(r.switchToDarkTheme), text: l(r.darkCapital), value: "dark" },
		],
		tags: [l(r.darkLower), l(r.lightLower)],
	}),
	t.Settings.registerSettingExtension({
		category: t.Settings.SettingCategory.APPEARANCE,
		storageType: t.Settings.SettingStorageType.Synced,
		title: l(r.panelLayout),
		settingName: "sidebarPosition",
		settingType: t.Settings.SettingType.ENUM,
		defaultValue: "auto",
		options: [
			{
				title: l(r.useHorizontalPanelLayout),
				text: l(r.horizontal),
				value: "bottom",
			},
			{
			...
			{ title: l(r.useAutomaticPanelLayout), text: l(r.auto), value: "auto" },
		],
	}),
	t.Settings.registerSettingExtension({
		category: t.Settings.SettingCategory.APPEARANCE,
		...
		options: [
			{
				...
				title: l(r.browserLanguage),
				text: l(r.browserLanguage),
			},
			...a.i18n
				.getAllSupportedDevToolsLocales()
				.sort()
				.map((t) => {
					return { value: (e = t), title: u(e), text: u(e) };
					var e;
				}),
		],
		reloadRequired: !0,
	...
	t.Settings.registerSettingExtension({
		category: t.Settings.SettingCategory.APPEARANCE,
		storageType: t.Settings.SettingStorageType.Synced,
		title: l(r.enableCtrlShortcutToSwitchPanels),
		titleMac: l(r.enableShortcutToSwitchPanels),
	...
	t.Settings.registerSettingExtension({
		...
		defaultValue: "right",
		options: [
			{ value: "right", text: l(r.right), title: l(r.dockToRight) },
			{ value: "bottom", text: l(r.bottom), title: l(r.dockToBottom) },
			{ value: "left", text: l(r.left), title: l(r.dockToLeft) },
			{
				value: "undocked",
				text: l(r.undocked),
				title: l(r.undockIntoSeparateWindow),
			},
		],
	}),
	t.Settings.registerSettingExtension({
		...
		options: [
			{
				...
				title: l(r.devtoolsDefault),
				text: l(r.devtoolsDefault),
			},
			{
				value: "vsCode",
				title: a.i18n.lockedLazyString("Visual Studio Code"),
				text: a.i18n.lockedLazyString("Visual Studio Code"),
			},
		],
	}),
	t.Settings.registerSettingExtension({
	...
	t.Settings.registerSettingExtension({
		category: t.Settings.SettingCategory.GLOBAL,
		storageType: t.Settings.SettingStorageType.Local,
		title: l(r.searchAsYouTypeSetting),
		settingName: "searchAsYouType",
		settingType: t.Settings.SettingType.BOOLEAN,
		order: 3,
		defaultValue: !0,
		options: [
			{ value: !0, title: l(r.searchAsYouTypeCommand) },
			{ value: !1, title: l(r.searchOnEnterCommand) },
		],
	}),
	n.ViewManager.registerLocationResolver({
		name: "drawer-view",
		category: n.ViewManager.ViewLocationCategory.DRAWER,
		loadResolver: async () => n.InspectorView.InspectorView.instance(),
	}),
	n.ViewManager.registerLocationResolver({
		name: "drawer-sidebar",
		category: n.ViewManager.ViewLocationCategory.DRAWER_SIDEBAR,
		loadResolver: async () => n.InspectorView.InspectorView.instance(),
	}),
	n.ViewManager.registerLocationResolver({
		name: "panel",
		category: n.ViewManager.ViewLocationCategory.PANEL,
		loadResolver: async () => n.InspectorView.InspectorView.instance(),
	}),
	n.ContextMenu.registerProvider({
		contextTypes: () => [
			o.UISourceCode.UISourceCode,
			e.Resource.Resource,
			e.NetworkRequest.NetworkRequest,
		],
		loadProvider: async () =>
			new i.Linkifier.ContentProviderContextMenuProvider(),
		experiment: void 0,
	}),
	n.ContextMenu.registerProvider({
		contextTypes: () => [Node],
		loadProvider: async () => new n.XLink.ContextMenuProvider(),
		experiment: void 0,
	}),
	n.ContextMenu.registerProvider({
		contextTypes: () => [Node],
		loadProvider: async () => new i.Linkifier.LinkContextMenuProvider(),
		experiment: void 0,
	}),
	n.Toolbar.registerToolbarItem({
		separator: !0,
		location: n.Toolbar.ToolbarItemLocation.MAIN_TOOLBAR_LEFT,
		order: 100,
		showLabel: void 0,
		actionId: void 0,
		condition: void 0,
	...
	n.Toolbar.registerToolbarItem({
		separator: !0,
		order: 97,
		location: n.Toolbar.ToolbarItemLocation.MAIN_TOOLBAR_RIGHT,
		showLabel: void 0,
		actionId: void 0,
		condition: void 0,
		loadItem: void 0,
	...
	n.Toolbar.registerToolbarItem({
		loadItem: async () =>
			(await d()).MainImpl.SettingsButtonProvider.instance(),
		order: 99,
		location: n.Toolbar.ToolbarItemLocation.MAIN_TOOLBAR_RIGHT,
		showLabel: void 0,
		condition: void 0,
	...
	n.Toolbar.registerToolbarItem({
		loadItem: async () => (await d()).MainImpl.MainMenuItem.instance(),
		order: 100,
		location: n.Toolbar.ToolbarItemLocation.MAIN_TOOLBAR_RIGHT,
		showLabel: void 0,
		condition: void 0,
	...
	n.Toolbar.registerToolbarItem({
		loadItem: async () => n.DockController.CloseButtonProvider.instance(),
		order: 101,
		location: n.Toolbar.ToolbarItemLocation.MAIN_TOOLBAR_RIGHT,
		showLabel: void 0,
		condition: void 0,
	...
	t.AppProvider.registerAppProvider({
		loadAppProvider: async () =>
			(await d()).SimpleApp.SimpleAppProvider.instance(),
		order: 10,
		condition: void 0,
	}));
