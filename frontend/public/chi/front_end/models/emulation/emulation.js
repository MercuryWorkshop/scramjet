	...
	static fromJSONV1(e) {
		try {
			...
			function r(e) {
				const o = {};
				if (
					((o.width = i(e, "width")), o.width < 0 || o.width > N || o.width < L)
				)
					throw new Error("Emulated device has wrong width: " + o.width);
				if (
					((o.height = i(e, "height")),
					o.height < 0 || o.height > N || o.height < L)
				)
...
class I extends e.ObjectWrapper.ObjectWrapper {
	...
	constructor() {
		(super(),
			...
			this.#v.get() && this.#v.get() < L && this.#v.set(L),
			this.#v.get() > N && this.#v.set(N),
			...
			(this.#x = e.Settings.Settings.instance().createSetting(
				...
				!0,
				e.Settings.SettingStorageType.Session
			)),
			(this.#y = P.None),
			(this.#z = null),
			(this.#I = null),
	...
	static widthValidator(e) {
		...
		return (
			/^[\d]+$/.test(e)
				? Number(e) > N
					? (t = y(M.widthMustBeLessThanOrEqualToS, { PH1: N }))
					: Number(e) < L
						? (t = y(M.widthMustBeGreaterThanOrEqualToS, { PH1: L }))
						: (i = !0)
	...
	static heightValidator(e) {
		...
		return (
			/^[\d]+$/.test(e)
				? Number(e) > N
					? (t = y(M.heightMustBeLessThanOrEqualToS, { PH1: N }))
					: Number(e) < L
						? (t = y(M.heightMustBeGreaterThanOrEqualTo, { PH1: L }))
						: (i = !0)
		...
		return (
			e
				? Number.isNaN(o)
					...
					: Number(e) > C
						? (t = y(M.devicePixelRatioMustBeLessThanOr, { PH1: C }))
						: Number(e) < E
							? (t = y(M.devicePixelRatioMustBeGreater, { PH1: E }))
							: (i = !0)
				: (i = !0),
			{ valid: i, errorMessage: t }
		);
	...
	setWidth(e) {
		const t = Math.min(N, this.preferredScaledWidth());
	...
	setHeight(e) {
		const t = Math.min(N, this.preferredScaledHeight());
	...
	isMobile() {
		switch (this.#y) {
			...
			case P.None:
				return !1;
			case P.Responsive:
				return this.#w.get() === T.Mobile || this.#w.get() === T.MobileNoTouch;
		}
		return !1;
	}
	enabledSetting() {
	...
	calculateAndEmulate(e) {
		...
		if (
			...
			((this.#A = this.calculateFitScale(this.#f.get(), this.#v.get())),
				...
				this.applyUserAgent(t ? K : "", t ? D : null),
				this.applyTouch(
					this.#w.get() === T.DesktopTouch || this.#w.get() === T.Mobile,
					this.#w.get() === T.Mobile
				));
		}
...
(!(function (e) {
	...
	(function (e) {
		((e.Mobile = "Mobile"),
			(e.MobileNoTouch = "Mobile (no touch)"),
			(e.Desktop = "Desktop"),
			(e.DesktopTouch = "Desktop (touch)"));
	})(T || (T = {})));
const L = 50,
	N = 9999,
	E = 0,
...
var O = Object.freeze({
	...
	MinDeviceSize: L,
	MaxDeviceSize: N,
	MinDeviceScaleFactor: E,
	MaxDeviceScaleFactor: C,
	MaxDeviceNameLength: 50,
	defaultMobileScaleFactor: F,
});
export { O as DeviceModeModel, S as EmulatedDevices };
