...
import * as l from "../../ui/components/panel_feedback/panel_feedback.js";
...
const c = {
		disabled: "Disabled",
		ifTrueThisElementCurrentlyCannot:
		...
		theAccessibleDescriptionForThis:
		...
		valueFromNativeHtmlUnknownSource:
			"Value from native HTML (unknown source).",
	},
	u = t.i18n.registerUIStrings(
		"panels/accessibility/AccessibilityStrings.ts",
		c
	),
	m = t.i18n.getLazilyComputedLocalizedString.bind(void 0, u),
	h = {
		disabled: {
			name: m(c.disabled),
			description: m(c.ifTrueThisElementCurrentlyCannot),
			group: "AXGlobalStates",
		},
		invalid: {
			name: m(c.invalidUserEntry),
			description: m(c.ifTrueThisElementsUserentered),
			group: "AXGlobalStates",
		},
		editable: {
			name: m(c.editable),
			description: m(c.ifAndHowThisElementCanBeEdited),
		},
		focusable: {
			name: m(c.focusable),
			description: m(c.ifTrueThisElementCanReceiveFocus),
		},
		focused: {
			name: m(c.focused),
			description: m(c.ifTrueThisElementCurrentlyHas),
		},
		settable: {
			name: m(c.canSetValue),
			description: m(c.whetherTheValueOfThisElementCan),
		},
		live: {
			name: m(c.liveRegion),
			description: m(c.whetherAndWhatPriorityOfLive),
			group: "AXLiveRegionAttributes",
		},
		atomic: {
			name: m(c.atomicLiveRegions),
			description: m(c.ifThisElementMayReceiveLive),
			group: "AXLiveRegionAttributes",
		},
		relevant: {
			name: m(c.relevantLiveRegions),
			description: m(c.ifThisElementMayReceiveLiveUpdates),
			group: "AXLiveRegionAttributes",
		},
		busy: {
			name: m(c.busyLiveRegions),
			description: m(c.whetherThisElementOrItsSubtree),
			group: "AXLiveRegionAttributes",
		},
		root: {
			name: m(c.liveRegionRoot),
			description: m(c.ifThisElementMayReceiveLiveUpdatesThe),
			group: "AXLiveRegionAttributes",
		},
		autocomplete: {
			name: m(c.hasAutocomplete),
			description: m(c.whetherAndWhatTypeOfAutocomplete),
			group: "AXWidgetAttributes",
		},
		haspopup: {
			name: m(c.hasPopup),
			description: m(c.whetherThisElementHasCausedSome),
			group: "AXWidgetAttributes",
		},
		level: {
			name: m(c.level),
			description: m(c.theHierarchicalLevelOfThis),
			group: "AXWidgetAttributes",
		},
		multiselectable: {
			name: m(c.multiselectable),
			description: m(c.whetherAUserMaySelectMoreThanOne),
			group: "AXWidgetAttributes",
		},
		orientation: {
			name: m(c.orientation),
			description: m(c.whetherThisLinearElements),
			group: "AXWidgetAttributes",
		},
		multiline: {
			name: m(c.multiline),
			description: m(c.whetherThisTextBoxMayHaveMore),
			group: "AXWidgetAttributes",
		},
		readonly: {
			name: m(c.readonlyString),
			description: m(c.ifTrueThisElementMayBeInteracted),
			group: "AXWidgetAttributes",
		},
		required: {
			name: m(c.requiredString),
			description: m(c.whetherThisElementIsARequired),
			group: "AXWidgetAttributes",
		},
		valuemin: {
			name: m(c.minimumValue),
			description: m(c.forARangeWidgetTheMinimumAllowed),
			group: "AXWidgetAttributes",
		},
		valuemax: {
			name: m(c.maximumValue),
			description: m(c.forARangeWidgetTheMaximumAllowed),
			group: "AXWidgetAttributes",
		},
		valuetext: {
			name: m(c.valueDescription),
			description: m(c.aHumanreadableVersionOfTheValue),
			group: "AXWidgetAttributes",
		},
		checked: {
			name: m(c.checked),
			description: m(c.whetherThisCheckboxRadioButtonOr),
			group: "AXWidgetStates",
		},
		expanded: {
			name: m(c.expanded),
			description: m(c.whetherThisElementOrAnother),
			group: "AXWidgetStates",
		},
		pressed: {
			name: m(c.pressed),
			description: m(c.whetherThisToggleButtonIs),
			group: "AXWidgetStates",
		},
		selected: {
			name: m(c.selectedString),
			description: m(c.whetherTheOptionRepresentedBy),
			group: "AXWidgetStates",
		},
		activedescendant: {
			name: m(c.activeDescendant),
			description: m(c.theDescendantOfThisElementWhich),
			group: "AXRelationshipAttributes",
		},
		flowto: {
			name: t.i18n.lockedLazyString("Flows to"),
			description: m(c.elementToWhichTheUserMayChooseTo),
			group: "AXRelationshipAttributes",
		},
		controls: {
			name: m(c.controls),
			description: m(c.elementOrElementsWhoseContentOr),
			group: "AXRelationshipAttributes",
		},
		describedby: {
			name: m(c.describedBy),
			description: m(c.elementOrElementsWhichFormThe),
			group: "AXRelationshipAttributes",
		},
		labelledby: {
			name: m(c.labeledBy),
			description: m(c.elementOrElementsWhichMayFormThe),
			group: "AXRelationshipAttributes",
		},
		owns: {
			name: t.i18n.lockedLazyString("Owns"),
			description: m(c.elementOrElementsWhichShouldBe),
			group: "AXRelationshipAttributes",
		},
		name: {
			name: t.i18n.lockedLazyString("Name"),
			description: m(c.theComputedNameOfThisElement),
			group: "Default",
		},
		role: {
			name: m(c.role),
			description: m(c.indicatesThePurposeOfThisElement),
			group: "Default",
		},
		value: {
			name: m(c.value),
			description: m(c.theValueOfThisElementThisMayBe),
			group: "Default",
		},
		help: {
			name: m(c.help),
			description: m(c.theComputedHelpTextForThis),
			group: "Default",
		},
		description: {
			name: m(c.description),
			description: m(c.theAccessibleDescriptionForThis),
			group: "Default",
		},
	},
	p = {
		attribute: {
			name: m(c.fromAttribute),
			description: m(c.valueFromAttribute),
		},
		implicit: { name: m(c.implicit), description: m(c.implicitValue) },
		style: { name: m(c.fromStyle), description: m(c.valueFromStyle) },
		contents: {
			name: m(c.contents),
			description: m(c.valueFromElementContents),
		},
		placeholder: {
			name: m(c.fromPlaceholderAttribute),
			description: m(c.valueFromPlaceholderAttribute),
		},
		relatedElement: {
			name: m(c.relatedElement),
			description: m(c.valueFromRelatedElement),
		},
	},
	b = {
		description: {
			name: m(c.fromDescription),
			description: m(c.valueFromDescriptionElement),
		},
		figcaption: {
			name: m(c.fromCaption),
			description: m(c.valueFromFigcaptionElement),
		},
		label: { name: m(c.fromLabel), description: m(c.valueFromLabelElement) },
		labelfor: {
			name: m(c.fromLabelFor),
			description: m(c.valueFromLabelElementWithFor),
		},
		labelwrapped: {
			name: m(c.fromLabelWrapped),
			description: m(c.valueFromLabelElementWrapped),
		},
		legend: { name: m(c.fromLegend), description: m(c.valueFromLegendElement) },
		rubyannotation: {
			name: m(c.fromRubyAnnotation),
			description: m(c.valueFromNativeHtmlRuby),
		},
		tablecaption: {
			name: m(c.fromCaption),
			description: m(c.valueFromTableCaption),
		},
		title: { name: m(c.fromTitle), description: m(c.valueFromTitleAttribute) },
		other: {
			name: m(c.fromNativeHtml),
			description: m(c.valueFromNativeHtmlUnknownSource),
		},
	};
var g = Object.freeze({
	__proto__: null,
...
class x extends r.View.SimpleView {
	axNode;
	nodeInternal;
	constructor(e) {
		(super(e), (this.axNode = null));
	}
	setAXNode(e) {}
	node() {
	...
	createInfo(e, t) {
		const a = t || "gray-info-message",
			r = this.element.createChild("div", a);
		return ((r.textContent = e), r);
	}
	createTreeOutline() {
		const e = new r.TreeOutline.TreeOutlineInShadow();
		return (
			e.registerCSSFiles([d, v, f]),
	...
	wasShown() {
		(super.wasShown(), this.registerCSSFiles([v]));
	}
}
var y = Object.freeze({ __proto__: null, AccessibilitySubPane: x });
const E = {
		...
		elementIsHiddenBy: "Element is hidden by active modal dialog: ",
		elementIsHiddenByChildTree: "Element is hidden by child tree: ",
		ancestorChildrenAreAll: "Ancestor's children are all presentational: ",
		elementIsPlaceholder: "Element is {PH1}.",
		placeholderIsPlaceholderOnAncestor: "{PH1} is {PH2} on ancestor: ",
		elementHasEmptyAltText: "Element has empty alt text.",
		noTextContent: "No text content.",
		elementIsInert: "Element is `inert`.",
		elementIsInAnInertSubTree: "Element is in an `inert` subtree from ",
		elementsInheritsPresentational:
	...
	w = t.i18n.registerUIStrings(
		"panels/accessibility/AccessibilityNodeView.ts",
		E
	),
	I = t.i18n.getLocalizedString.bind(void 0, w);
class A extends x {
	axNode;
	noNodeInfo;
	ignoredInfo;
	...
	ignoredReasonsTree;
	constructor() {
		(super(I(E.computedProperties)),
			(this.axNode = null),
			this.contentElement.classList.add("ax-subpane"),
			this.contentElement.setAttribute(
				"jslog",
				`${n.pane().context("computed-properties")}`
			),
			(this.noNodeInfo = this.createInfo(I(E.noAccessibilityNode))),
			(this.ignoredInfo = this.createInfo(
				I(E.accessibilityNodeNotExposed),
	...
	setAXNode(e) {
		...
		this.axNode = e;
		const t = this.treeOutline;
		t.removeChildren();
		const r = this.ignoredReasonsTree;
		if ((r.removeChildren(), !e))
			return (
				...
				void this.element.classList.add("ax-ignored-node-pane")
			);
		if (e.ignored()) {
			...
			const a = e.ignoredReasons();
			for (const t of a) ((n = t), r.appendChild(new R(n, e)));
			return void (r.firstChild() || r.element.classList.add("hidden"));
		}
		var n;
		function i(a) {
			t.appendChild(new C(a, e));
		}
		...
		for (const t of e.coreProperties()) i(t);
		const s = e.role();
		if (s) {
			i({ name: a.AccessibilityModel.CoreAxPropertyName.Role, value: s });
		}
		for (const t of e.properties()) i(t);
	...
	wasShown() {
		(super.wasShown(), this.registerCSSFiles([d]));
	}
}
class N extends r.TreeOutline.TreeElement {
	axNode;
	constructor(e) {
		(super(""), (this.axNode = e));
	}
	static createSimpleValueElement(e, t) {
		let a, n;
		e && "valueUndefined" !== e && "computedString" !== e
			? ((a = document.createElement("span")), a.classList.add("monospace"))
			: (a = document.createElement("span"));
		return (
			(n = e && T.has(e) ? '"' + t.replace(/\n/g, "↵") + '"' : String(t)),
			e && e in k && a.classList.add(k[e]),
			a.setTextContentTruncatedIfNeeded(n || ""),
			r.Tooltip.Tooltip.install(a, String(t) || ""),
			a
		);
	}
	static createExclamationMark(e) {
		const t = r.UIUtils.createIconLabel({
			iconName: "warning-filled",
			color: "var(--icon-warning)",
		});
		return (r.Tooltip.Tooltip.install(t, e), t);
	}
	appendNameElement(e) {
		...
		if (e in h) {
			...
			((t.textContent = a.name()),
				r.Tooltip.Tooltip.install(t, a.description()),
				t.classList.add("ax-readable-name"));
		} else
			((t.textContent = e),
				t.classList.add("ax-name"),
				t.classList.add("monospace"));
	...
	appendValueElement(e) {
		if (
			...
			return void this.appendRelatedNodeListValueElement(e);
		if (e.sources) {
			const t = e.sources;
			for (let e = 0; e < t.length; e++) {
				const a = t[e],
					r = new M(a, this.axNode);
				this.appendChild(r);
			}
			this.expand();
		}
		const t = N.createSimpleValueElement(e.type, String(e.value));
		this.listItemElement.appendChild(t);
	}
	appendRelatedNode(e, t) {
		const r = new a.DOMModel.DeferredDOMNode(
				this.axNode.accessibilityModel().target(),
				e.backendDOMNodeId
			),
			n = new L({ deferredNode: r, idref: void 0 }, e);
		this.appendChild(n);
	}
	appendRelatedNodeInline(e) {
		const t = new a.DOMModel.DeferredDOMNode(
				this.axNode.accessibilityModel().target(),
				e.backendDOMNodeId
			),
			r = new S({ deferredNode: t, idref: void 0 }, e);
		this.listItemElement.appendChild(r.render());
	}
	appendRelatedNodeListValueElement(e) {
		!e.relatedNodes || 1 !== e.relatedNodes.length || e.value
			? (e.relatedNodes && e.relatedNodes.forEach(this.appendRelatedNode, this),
				e.relatedNodes && e.relatedNodes.length <= 3
					? this.expand()
					: this.collapse())
...
const k = {
	...
	T = new Set(["string", "computedString", "idrefList", "idref"]);
class C extends N {
	property;
	toggleOnClick;
	constructor(e, t) {
...
class M extends N {
	...
	appendRelatedNodeWithIdref(e, t) {
		const r = new a.DOMModel.DeferredDOMNode(
				this.axNode.accessibilityModel().target(),
				e.backendDOMNodeId
			),
			n = new L({ deferredNode: r, idref: t }, e);
		this.appendChild(n);
	}
	appendIDRefValueElement(e) {
		if (null === e.value) return;
		const t = e.relatedNodes || [];
		if ("" === e.value) {
			for (const e of t) {
				const t = e.idref || "";
				this.appendRelatedNodeWithIdref(e, t);
			}
			return;
		}
		const a = e.value.trim().split(/\s+/);
		for (const e of a) {
			const r = t.find((t) => t.idref === e);
			r
				? this.appendRelatedNodeWithIdref(r, e)
				: 1 === a.length
					? this.listItemElement.appendChild(
							new S({ deferredNode: void 0, idref: e }).render()
						)
					: this.appendChild(new L({ deferredNode: void 0, idref: e }));
		}
	}
	appendRelatedNodeListValueElement(e) {
		const t = e.relatedNodes,
			a = t ? t.length : 0;
		("idrefList" === e.type || "idref" === e.type
			? this.appendIDRefValueElement(e)
			: super.appendRelatedNodeListValueElement(e),
			a <= 3 ? this.expand() : this.collapse());
	}
		...
		switch (a) {
			...
			case "relatedElement":
				if (e.nativeSource) {
					...
					((t.textContent = b[a].name()),
						r.Tooltip.Tooltip.install(t, b[a].description()),
						t.classList.add("ax-readable-name"));
					break;
				}
				((t.textContent = e.attribute || null),
					t.classList.add("ax-name"),
					t.classList.add("monospace"));
				break;
			default:
				a in p
					? ((t.textContent = p[a].name()),
						r.Tooltip.Tooltip.install(t, p[a].description()),
						t.classList.add("ax-readable-name"))
					: (console.warn(a, "not in AXSourceTypes"), (t.textContent = a));
		}
		this.listItemElement.appendChild(t);
	}
	update() {
		if ((this.listItemElement.removeChildren(), this.source.invalid)) {
			const e = N.createExclamationMark(I(E.invalidSource));
		...
		if (
			...
			(this.appendValueElement(this.source.attributeValue),
				r.UIUtils.createTextChild(this.listItemElement, " "));
			...
			const e = N.createSimpleValueElement("valueUndefined", I(E.notSpecified));
			(this.listItemElement.appendChild(e),
				this.listItemElement.classList.add("ax-value-source-unused"));
		}
		this.source.value &&
...
class L extends r.TreeOutline.TreeElement {
	value;
	axRelatedNodeElement;
	constructor(e, t) {
		(super(""),
			(this.value = t),
			(this.axRelatedNodeElement = new S(e, t)),
			(this.selectable = !0));
	}
	onattach() {
		(this.listItemElement.appendChild(this.axRelatedNodeElement.render()),
			this.value &&
				this.value.text &&
				this.listItemElement.appendChild(
					N.createSimpleValueElement("computedString", this.value.text)
				));
	}
	onenter() {
...
class S {
	...
	value;
	constructor(e, t) {
		((this.deferredNode = e.deferredNode),
			(this.idref = e.idref),
			(this.value = t));
	}
	render() {
		...
		if (this.deferredNode) {
			...
			(t.appendChild(a),
				this.deferredNode.resolvePromise().then((t) => {
					e.Linkifier.Linkifier.linkify(t, {
						tooltip: void 0,
						preventKeyboardFocus: !0,
					}).then((e) => a.appendChild(e));
				}));
		} else if (this.idref) {
			t.classList.add("invalid");
			const e = N.createExclamationMark(I(E.noNodeWithThisId));
			(r.UIUtils.createTextChild(e, this.idref), t.appendChild(e));
		}
		return t;
	}
	revealNode() {
		this.deferredNode &&
			this.deferredNode.resolvePromise().then((t) => e.Revealer.reveal(t));
	}
}
class R extends N {
	property;
	...
	static createReasonElement(e, a) {
		...
		switch (e) {
			case "activeModalDialog":
				r = t.i18n.getFormatLocalizedString(w, E.elementIsHiddenBy, {});
				break;
			case "hiddenByChildTree":
				r = t.i18n.getFormatLocalizedString(
					w,
					E.elementIsHiddenByChildTree,
					{}
				);
				break;
			case "ancestorIsLeafNode":
				r = t.i18n.getFormatLocalizedString(w, E.ancestorChildrenAreAll, {});
				break;
			case "ariaHiddenElement": {
				const e = (document.createElement("span", {
					is: "source-code",
				}).textContent = "aria-hidden");
				r = t.i18n.getFormatLocalizedString(w, E.elementIsPlaceholder, {
					PH1: e,
				});
				break;
			}
			case "ariaHiddenSubtree": {
				...
				r = t.i18n.getFormatLocalizedString(
					w,
					E.placeholderIsPlaceholderOnAncestor,
					{ PH1: e, PH2: a }
				);
				break;
			}
			case "emptyAlt":
				r = t.i18n.getFormatLocalizedString(w, E.elementHasEmptyAltText, {});
				break;
			case "emptyText":
				r = t.i18n.getFormatLocalizedString(w, E.noTextContent, {});
				break;
			case "inertElement":
				r = t.i18n.getFormatLocalizedString(w, E.elementIsInert, {});
				break;
			case "inertSubtree":
				r = t.i18n.getFormatLocalizedString(w, E.elementIsInAnInertSubTree, {});
				break;
			case "inheritsPresentation":
				r = t.i18n.getFormatLocalizedString(
					w,
					E.elementsInheritsPresentational,
					{}
				);
				break;
			case "labelContainer":
				r = t.i18n.getFormatLocalizedString(w, E.partOfLabelElement, {});
				break;
			case "labelFor":
				r = t.i18n.getFormatLocalizedString(w, E.labelFor, {});
				break;
			case "notRendered":
				r = t.i18n.getFormatLocalizedString(w, E.elementIsNotRendered, {});
				break;
			case "notVisible":
				r = t.i18n.getFormatLocalizedString(w, E.elementIsNotVisible, {});
				break;
			case "presentationalRole": {
				const e = (a && a.role()?.value) || "",
					n = (document.createElement("span", {
						is: "source-code",
					}).textContent = "role=" + e);
				r = t.i18n.getFormatLocalizedString(w, E.elementHasPlaceholder, {
					PH1: n,
				});
				break;
			}
			case "probablyPresentational":
				r = t.i18n.getFormatLocalizedString(w, E.elementIsPresentational, {});
				break;
			case "uninteresting":
				r = t.i18n.getFormatLocalizedString(w, E.elementNotInteresting, {});
		}
		return (r && r.classList.add("ax-reason"), r);
	}
	onattach() {
		(this.listItemElement.removeChildren(),
			(this.reasonElement = R.createReasonElement(
				this.property.name,
				this.axNode
			)),
			this.reasonElement &&
				this.listItemElement.appendChild(this.reasonElement));
		const e = this.property.value;
		"idref" === e.type && this.appendRelatedNodeListValueElement(e);
	}
}
var F = Object.freeze({
	__proto__: null,
	AXNodeSubPane: A,
	AXNodePropertyTreeElement: N,
	TypeStyles: k,
	StringProperties: T,
	AXNodePropertyTreePropertyElement: C,
	AXValueSourceTreeElement: M,
	AXRelatedNodeSourceTreeElement: L,
	AXRelatedNodeElement: S,
	AXNodeIgnoredReasonTreeElement: R,
});
const O = {
	attributes: [
		{ name: "aria-activedescendant", type: "IDREF" },
		{ default: "false", name: "aria-atomic", type: "boolean" },
		{
			default: "none",
		...
		{ default: "false", name: "aria-busy", type: "boolean" },
		{
			default: "undefined",
		...
		{ default: "false", name: "aria-disabled", type: "boolean" },
		{
			default: "none",
		...
		{ default: "false", name: "aria-modal", type: "boolean" },
		{ default: "false", name: "aria-multiline", type: "boolean" },
		{ default: "false", name: "aria-multiselectable", type: "boolean" },
		{
			default: "undefined",
		...
		{ default: "false", name: "aria-readonly", type: "boolean" },
		{
		...
		{ default: "false", name: "aria-required", type: "boolean" },
...
class P {
	...
	initialize(e) {
		const t = e.attributes,
			a = ["true", "false"];
		for (const e of t)
			("boolean" === e.type && (e.enum = a),
				this.attributes.set(e.name, new B(e)));
		this.roleNames = e.roles.map((e) => e.name);
	}
	valuesForProperty(e) {
		const t = this.attributes.get(e);
		return t ? t.getEnum() : "role" === e ? this.roleNames : [];
	}
}
let D;
function V() {
	return (D || (D = new P(O || null)), D);
}
class B {
	enum;
	constructor(e) {
...
const q = {
	...
	H = t.i18n.registerUIStrings("panels/accessibility/ARIAAttributesView.ts", q),
	j = t.i18n.getLocalizedString.bind(void 0, H);
class U extends x {
	noPropertiesInfo;
	treeOutline;
	constructor() {
		(super(j(q.ariaAttributes)),
			(this.noPropertiesInfo = this.createInfo(j(q.noAriaAttributes))),
			(this.treeOutline = this.createTreeOutline()),
			this.element.setAttribute(
				"jslog",
				`${n.pane().context("aria-attributes")}`
			));
	}
	setNode(e) {
		if ((super.setNode(e), this.treeOutline.removeChildren(), !e)) return;
		const t = e.domModel().target(),
			a = e.attributes();
		for (let e = 0; e < a.length; ++e) {
			const r = a[e];
			this.isARIAAttribute(r) &&
				this.treeOutline.appendChild(new X(this, r, t));
		}
		const r = 0 !== this.treeOutline.rootElement().childCount();
		(this.noPropertiesInfo.classList.toggle("hidden", r),
			this.treeOutline.element.classList.toggle("hidden", !r));
	}
	isARIAAttribute(e) {
		return _.has(e.name);
	}
}
class X extends r.TreeOutline.TreeElement {
	parentPane;
	attribute;
	nameElement;
	valueElement;
	...
	static createARIAValueElement(e) {
		const t = document.createElement("span");
		return (
			t.classList.add("monospace"),
			t.setTextContentTruncatedIfNeeded(e || ""),
			t
		);
	}
	onattach() {
	...
	appendNameElement(e) {
		((this.nameElement = document.createElement("span")),
			(this.nameElement.textContent = e),
			this.nameElement.classList.add("ax-name"),
			this.nameElement.classList.add("monospace"),
			this.listItemElement.appendChild(this.nameElement));
	}
	appendAttributeValueElement(e) {
		((this.valueElement = X.createARIAValueElement(e)),
			this.listItemElement.appendChild(this.valueElement));
	}
	mouseClick(e) {
		e.target !== this.listItemElement && (e.consume(!0), this.startEditing());
	}
	startEditing() {
		const e = this.valueElement;
		if (!e || r.UIUtils.isBeingEdited(e)) return;
		const t = e.textContent || "";
		const a = this.nameElement.textContent || "";
		((this.prompt = new z(V().valuesForProperty(a), this)),
			this.prompt.setAutocompletionTimeout(0));
		const n = this.prompt.attachAndStartEditing(
			e,
			function (e, t) {
				const a = t.target.textContent || "";
				this.editingCommitted(a, e);
			}.bind(this, t)
		);
		n.addEventListener("keydown", (e) => this.editingValueKeyDown(t, e), !1);
		const i = e.getComponentSelection();
		i && i.selectAllChildren(e);
	}
	removePrompt() {
		this.prompt && (this.prompt.detach(), delete this.prompt);
	}
	editingCommitted(e, t) {
		if ((this.removePrompt(), e !== t)) {
			this.parentPane.node().setAttributeValue(this.attribute.name, e);
		}
	}
	editingCancelled() {
		(this.removePrompt(), this.populateListItem());
	}
	editingValueKeyDown(e, t) {
		if (!t.handled) {
			if ("Enter" === t.key) {
				const a = t.target;
				return (
					this.editingCommitted(a.textContent || "", e),
					void t.consume()
				);
			}
			return s.KeyboardUtilities.isEscKey(t)
				? (this.editingCancelled(), void t.consume())
				: void 0;
		}
	}
}
class z extends r.TextPrompt.TextPrompt {
	ariaCompletions;
	treeElement;
	constructor(e, t) {
		(super(),
			this.initialize(this.buildPropertyCompletions.bind(this)),
			(this.ariaCompletions = e),
			(this.treeElement = t));
	}
	async buildPropertyCompletions(e, t, a) {
		return (t = t.toLowerCase()) || a || !e
			? this.ariaCompletions
...
const $ = {
		...
		fullTreeExperimentDescription:
			"The accessibility tree moved to the top right corner of the DOM tree.",
		reloadRequired: "Reload required before the change takes effect.",
	},
	Y = t.i18n.registerUIStrings("panels/accessibility/AXBreadcrumbsPane.ts", $),
	J = t.i18n.getLocalizedString.bind(void 0, Y);
class Q extends x {
	axSidebarView;
	...
	#e = !1;
	constructor(e) {
		(super(J($.accessibilityTree)),
			this.element.classList.add("ax-subpane"),
			(this.element.tabIndex = -1),
			(this.axSidebarView = e),
		...
		const t = new l.PreviewToggle.PreviewToggle();
		t.setAttribute("jslog", `${n.toggle().context("fullAccessibilityTree")}`);
		const a = J($.fullTreeExperimentName),
			s = i.Runtime.ExperimentName.FULL_ACCESSIBILITY_TREE,
			d = (e) => {
				(o.userMetrics.experimentChanged(s, e),
					r.InspectorView.InspectorView.instance().displayReloadRequiredWarning(
						J($.reloadRequired)
					));
			};
		if (i.Runtime.experiments.isEnabled(s)) {
			this.#e = !0;
			const e = "https://g.co/devtools/a11y-tree-feedback";
			return (
				(t.data = {
					name: a,
					helperText: J($.fullTreeExperimentDescription),
					feedbackURL: e,
					experiment: s,
					onChangeCallback: d,
				}),
				void this.element.appendChild(t)
			);
		}
		((t.data = {
			name: a,
			...
			r.ARIAUtils.markAsTree(this.rootElement),
			...
			this.rootElement.addEventListener("click", this.onClick.bind(this), !1),
			this.rootElement.addEventListener(
				"contextmenu",
	...
	focus() {
		this.inspectedNodeBreadcrumb
			? this.inspectedNodeBreadcrumb.nodeElement().focus()
			: this.element.focus();
	}
	setAXNode(e) {
		if (this.#e) return;
		const t = this.element.hasFocus();
		if ((super.setAXNode(e), this.rootElement.removeChildren(), !e)) return;
		const a = [];
		let r = e;
		for (; r; ) (a.push(r), (r = r.parentNode()));
		a.reverse();
		let n = 0,
			i = null;
		for (r of ((this.inspectedNodeBreadcrumb = null), a)) {
			if (r !== e && r.ignored() && r.parentNode()) continue;
			const t = new ee(r, n, r === e);
			(i ? i.appendChild(t) : this.rootElement.appendChild(t.element()),
				(i = t),
				n++,
				(this.inspectedNodeBreadcrumb = t));
		}
		function s(e, t, a) {
			if (t.ignored()) return void t.children().map((t) => s(e, t, a));
			const r = new ee(t, a, !1);
			e.appendChild(r);
			for (const e of t.children()) s(r, e, a + 1);
		}
		if (
			(this.inspectedNodeBreadcrumb &&
				this.inspectedNodeBreadcrumb.setPreselected(!0, t),
			this.setPreselectedBreadcrumb(this.inspectedNodeBreadcrumb),
			this.inspectedNodeBreadcrumb && !e.ignored())
		)
			for (const t of e.children())
				(s(this.inspectedNodeBreadcrumb, t, n),
					t.backendDOMNodeId() === this.collapsingBreadcrumbId &&
						this.setPreselectedBreadcrumb(
							this.inspectedNodeBreadcrumb.lastChild()
						));
		this.collapsingBreadcrumbId = -1;
	}
	willHide() {
	...
	onKeyDown(e) {
		const t = this.preselectedBreadcrumb;
		if (!t) return;
		const a = e;
		if (!a.composedPath().some((e) => e === t.element())) return;
		if (a.shiftKey || a.metaKey || a.ctrlKey) return;
		let r = !1;
		("ArrowUp" !== a.key || a.altKey
			? "ArrowDown" !== a.key || a.altKey
				? "ArrowLeft" !== a.key || a.altKey
					? ("Enter" === a.key ||
							("ArrowRight" === a.key &&
								!a.altKey &&
								t.axNode().hasOnlyUnloadedChildren())) &&
						(r = this.inspectDOMNode(t.axNode()))
					: t.hasExpandedChildren()
						? this.collapseBreadcrumb(t)
						: (r = this.preselectParent())
				: (r = this.preselectNext())
			: (r = this.preselectPrevious()),
			r && a.consume(!0));
	}
	preselectPrevious() {
		if (!this.preselectedBreadcrumb) return !1;
		const e = this.preselectedBreadcrumb.previousBreadcrumb();
		return !!e && (this.setPreselectedBreadcrumb(e), !0);
	}
	preselectNext() {
		if (!this.preselectedBreadcrumb) return !1;
		const e = this.preselectedBreadcrumb.nextBreadcrumb();
		return !!e && (this.setPreselectedBreadcrumb(e), !0);
	}
	preselectParent() {
		if (!this.preselectedBreadcrumb) return !1;
		const e = this.preselectedBreadcrumb.parentBreadcrumb();
		return !!e && (this.setPreselectedBreadcrumb(e), !0);
	}
	setPreselectedBreadcrumb(e) {
		if (e === this.preselectedBreadcrumb) return;
		const t = this.element.hasFocus();
		(this.preselectedBreadcrumb &&
			this.preselectedBreadcrumb.setPreselected(!1, t),
			(this.preselectedBreadcrumb = e || this.inspectedNodeBreadcrumb),
			this.preselectedBreadcrumb &&
				this.preselectedBreadcrumb.setPreselected(!0, t),
			!e && t && a.OverlayModel.OverlayModel.hideDOMNodeHighlight());
	}
	collapseBreadcrumb(e) {
		if (!e.parentBreadcrumb()) return;
		const t = e.axNode().backendDOMNodeId();
		null !== t && (this.collapsingBreadcrumbId = t);
		const a = e.parentBreadcrumb();
		a && this.inspectDOMNode(a.axNode());
	}
	onMouseLeave(e) {
	...
	onMouseMove(e) {
		const t = e.target;
		if (!t) return;
		const a = t.enclosingNodeOrSelfWithClass("ax-breadcrumb");
		if (!a) return void this.setHoveredBreadcrumb(null);
		const r = Z.get(a);
		r && r.isDOMNode() && this.setHoveredBreadcrumb(r);
	}
	onFocusOut(e) {
		this.preselectedBreadcrumb &&
			e.target === this.preselectedBreadcrumb.nodeElement() &&
			this.setPreselectedBreadcrumb(null);
	}
	onClick(e) {
		const t = e.target;
		...
		return r
			? r.inspected()
				? (this.collapseBreadcrumb(r),
					r.nodeElement().focus(),
					void n.logClick(r.expandLoggable, e))
				: void (
						r.isDOMNode() &&
						(this.inspectDOMNode(r.axNode()), n.logClick(r.expandLoggable, e))
					)
			: void 0;
	}
	setHoveredBreadcrumb(e) {
		if (e === this.hoveredBreadcrumb) return;
		this.hoveredBreadcrumb && this.hoveredBreadcrumb.setHovered(!1);
		const t = this.node();
		(e
			? e.setHovered(!0)
			: t &&
				t.id &&
				t.domModel().overlayModel().nodeHighlightRequested({ nodeId: t.id }),
			(this.hoveredBreadcrumb = e));
	}
	inspectDOMNode(t) {
		if (!t.isDOMNode()) return !1;
		const a = t.deferredDOMNode();
		return (
			a &&
				a.resolve((t) => {
					(this.axSidebarView.setNode(t, !0), e.Revealer.reveal(t, !0));
				}),
			!0
		);
	}
	contextMenuEventFired(e) {
		...
		if (!n) return;
		const i = n.axNode();
		if (!i.isDOMNode() || !i.deferredDOMNode()) return;
		const s = new r.ContextMenu.ContextMenu(e);
		s.viewSection().appendItem(J($.scrollIntoView), () => {
			const e = i.deferredDOMNode();
			e &&
				e.resolvePromise().then((e) => {
					e && e.scrollIntoView();
				});
		});
		const o = i.deferredDOMNode();
		(o && s.appendApplicableItems(o), s.show());
	}
	wasShown() {
		(super.wasShown(), this.registerCSSFiles([G]));
	}
}
const Z = new WeakMap();
class ee {
	...
	constructor(e, t, a) {
		if (
			...
			r.ARIAUtils.markAsGroup(this.childrenGroupElement),
			this.elementInternal.appendChild(this.childrenGroupElement),
			(this.children = []),
			(this.hovered = !1),
			(this.preselectedInternal = !1),
			(this.parent = null),
			(this.inspectedInternal = a),
			this.nodeElementInternal.classList.toggle("inspected", a),
			(this.nodeElementInternal.style.paddingLeft = 16 * t + 4 + "px"),
			this.axNodeInternal.ignored())
		)
			this.appendIgnoredNodeElement();
		else {
			this.appendRoleElement(this.axNodeInternal.role());
			const e = this.axNodeInternal.name();
			e &&
				e.value &&
				((this.nodeWrapper.createChild("span", "separator").textContent = " "),
				this.appendNameElement(e.value));
		}
		(!this.axNodeInternal.ignored() &&
			this.axNodeInternal.hasOnlyUnloadedChildren() &&
			(this.nodeElementInternal.classList.add("children-unloaded"),
			r.ARIAUtils.setExpanded(this.nodeElementInternal, !1),
			n.registerLoggable(
				this.expandLoggable,
				`${n.treeItemExpand()}`,
				this.elementInternal
			)),
			this.axNodeInternal.isDOMNode() ||
	...
	appendChild(e) {
		(this.children.push(e),
			...
			r.ARIAUtils.setExpanded(this.nodeElementInternal, !0),
			this.childrenGroupElement.appendChild(e.element()),
			n.registerLoggable(
				this.expandLoggable,
				`${n.treeItemExpand()}`,
				this.elementInternal
	...
	setPreselected(e, t) {
		this.preselectedInternal !== e &&
			((this.preselectedInternal = e),
			this.nodeElementInternal.classList.toggle("preselected", e),
			(this.nodeElementInternal.tabIndex = e ? 0 : -1),
			this.preselectedInternal &&
				(t && this.nodeElementInternal.focus(),
				this.inspectedInternal
	...
	setHovered(e) {
		this.hovered !== e &&
			((this.hovered = e),
			this.nodeElementInternal.classList.toggle("hovered", e),
			this.hovered &&
				(this.nodeElementInternal.classList.toggle("hovered", !0),
				this.axNodeInternal.highlightDOMNode()));
	}
	axNode() {
	...
	nextBreadcrumb() {
		...
		const e = this.element().nextSibling;
		return (e && Z.get(e)) || null;
	}
	previousBreadcrumb() {
		const e = this.element().previousSibling;
		return e ? Z.get(e) || null : this.parent;
	}
	parentBreadcrumb() {
		return this.parent;
	}
	...
	appendNameElement(e) {
		const t = document.createElement("span");
		((t.textContent = '"' + e + '"'),
			t.classList.add("ax-readable-string"),
			this.nodeWrapper.appendChild(t));
	}
	appendRoleElement(e) {
		if (!e) return;
		const t = document.createElement("span");
		(t.classList.add("monospace"),
			t.classList.add(te[e.type]),
			t.setTextContentTruncatedIfNeeded(e.value || ""),
			this.nodeWrapper.appendChild(t));
	}
	appendIgnoredNodeElement() {
		const e = document.createElement("span");
		(e.classList.add("monospace"),
			(e.textContent = J($.ignored)),
			e.classList.add("ax-breadcrumbs-ignored-node"),
			this.nodeWrapper.appendChild(e));
	}
}
const te = { internalRole: "ax-internal-role", role: "ax-role" };
...
const re = {
	...
	ne = t.i18n.registerUIStrings("panels/accessibility/SourceOrderView.ts", re),
	ie = t.i18n.getLocalizedString.bind(void 0, ne);
class se extends x {
	noNodeInfo;
	warning;
	checked;
	...
	overlayModel;
	constructor() {
		(super(ie(re.sourceOrderViewer)),
			this.element.setAttribute("jslog", `${n.pane().context("source-order")}`),
			(this.noNodeInfo = this.createInfo(ie(re.noSourceOrderInformation))),
			(this.warning = this.createInfo(ie(re.thereMayBeADelayInDisplaying))),
			(this.warning.id = "source-order-warning"),
			(this.checked = !1),
			(this.checkboxLabel = r.UIUtils.CheckboxLabel.create(
				ie(re.showSourceOrder),
				!1
			)),
			...
			this.checkboxLabel.setAttribute(
				"jslog",
				`${n.toggle().track({ click: !0 })}`
			),
			this.checkboxElement.addEventListener(
				"click",
				this.checkboxClicked.bind(this),
				!1
			),
	...
	async setNodeAsync(e) {
		if (
			(this.checkboxLabel.classList.contains("hidden") ||
				(this.checked = this.checkboxElement.checked),
			(this.checkboxElement.checked = !1),
			this.checkboxClicked(),
			super.setNode(e),
			!this.nodeInternal)
		)
			return void (this.overlayModel = null);
		let t = !1;
		const a = this.nodeInternal.childNodeCount();
		if (a > 0) {
			this.nodeInternal.children() ||
				(await this.nodeInternal.getSubtree(1, !1));
			t = this.nodeInternal
				.children()
				.some((e) => e.nodeType() === Node.ELEMENT_NODE);
		}
		(this.noNodeInfo.classList.toggle("hidden", t),
			this.warning.classList.toggle("hidden", a < 300),
			this.checkboxLabel.classList.toggle("hidden", !t),
			t
		...
		this.nodeInternal &&
			...
			(this.checkboxElement.checked
				? (o.userMetrics.actionTaken(
						o.UserMetrics.Action.SourceOrderViewActivated
					),
...
let oe;
class le extends r.ThrottledWidget.ThrottledWidget {
	nodeInternal;
	axNodeInternal;
	skipNextPullNode;
	sidebarPaneStack;
	...
	static instance(e) {
		return ((oe && !e?.forceNew) || (oe = new le(e?.throttlingTimeout)), oe);
	}
	node() {
	...
	setNode(e, t) {
		((this.skipNextPullNode = Boolean(t)),
			(this.nodeInternal = e),
			this.update());
	}
	accessibilityNodeCallback(e) {
		e &&
			...
			this.axNodeSubPane && this.axNodeSubPane.setAXNode(e),
			this.breadcrumbsSubPane && this.breadcrumbsSubPane.setAXNode(e));
	}
	async doUpdate() {
		const e = this.node();
		if (
			...
			this.breadcrumbsSubPane && this.breadcrumbsSubPane.setNode(e),
		...
		const t = e
			.domModel()
			.target()
			.model(a.AccessibilityModel.AccessibilityModel);
		t &&
			(i.Runtime.experiments.isEnabled("fullAccessibilityTree") || t.clear(),
			await t.requestPartialAXTree(e),
			this.accessibilityNodeCallback(t.axNodeForDOMNode(e)));
	}
	wasShown() {
		(super.wasShown(),
			this.doUpdate(),
			a.TargetManager.TargetManager.instance().addModelListener(
				a.DOMModel.DOMModel,
				a.DOMModel.Events.AttrModified,
				this.onNodeChange,
				this,
				{ scoped: !0 }
			),
	...
	pullNode() {
		this.skipNextPullNode
			? (this.skipNextPullNode = !1)
			: this.setNode(r.Context.Context.instance().flavor(a.DOMModel.DOMNode));
	}
	onNodeChange(e) {
		if (!this.node()) return;
		const t = e.data,
			r = t instanceof a.DOMModel.DOMNode ? t : t.node;
		this.node() === r && this.update();
	}
}
var de = Object.freeze({ __proto__: null, AccessibilitySidebarView: le });
export {
	K as ARIAAttributesView,
	W as ARIAMetadata,
	ae as AXBreadcrumbsPane,
	F as AccessibilityNodeView,
	de as AccessibilitySidebarView,
	g as AccessibilityStrings,
	y as AccessibilitySubPane,
};
