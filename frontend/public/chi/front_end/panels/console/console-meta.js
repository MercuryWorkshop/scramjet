...
const s = {
	...
	n = o.i18n.registerUIStrings("panels/console/console-meta.ts", s),
	i = o.i18n.getLazilyComputedLocalizedString.bind(void 0, n);
let a;
async function r() {
	return (a || (a = await import("./console.js")), a);
}
(t.ViewManager.registerViewExtension({
	location: "panel",
	id: "console",
	title: i(s.console),
	commandPrompt: i(s.showConsole),
	order: 20,
	loadView: async () => (await r()).ConsolePanel.ConsolePanel.instance(),
}),
	t.ViewManager.registerViewExtension({
		...
		order: 0,
		loadView: async () => (await r()).ConsolePanel.WrapperView.instance(),
	}),
	t.ActionRegistration.registerActionExtension({
		actionId: "console.toggle",
		category: t.ActionRegistration.ActionCategory.CONSOLE,
		title: i(s.toggleConsole),
		loadActionDelegate: async () =>
			new (await r()).ConsoleView.ActionDelegate(),
		bindings: [
	...
	t.ActionRegistration.registerActionExtension({
		...
		category: t.ActionRegistration.ActionCategory.CONSOLE,
		title: i(s.clearConsole),
		iconClass: "clear",
		loadActionDelegate: async () =>
			new (await r()).ConsoleView.ActionDelegate(),
		contextTypes() {
			return (
				(e = (e) => [e.ConsoleView.ConsoleView]),
				void 0 === a ? [] : e(a)
			);
			var e;
		},
	...
	t.ActionRegistration.registerActionExtension({
		...
		category: t.ActionRegistration.ActionCategory.CONSOLE,
		title: i(s.createLiveExpression),
		iconClass: "eye",
		loadActionDelegate: async () =>
			new (await r()).ConsoleView.ActionDelegate(),
	}),
	e.Settings.registerSettingExtension({
		...
		title: i(s.hideNetworkMessages),
		settingName: "hideNetworkMessages",
		settingType: e.Settings.SettingType.BOOLEAN,
		defaultValue: !1,
		options: [
			{ value: !0, title: i(s.hideNetworkMessages) },
			{ value: !1, title: i(s.showNetworkMessages) },
		],
	}),
	e.Settings.registerSettingExtension({
		category: e.Settings.SettingCategory.CONSOLE,
		storageType: e.Settings.SettingStorageType.Synced,
		title: i(s.selectedContextOnly),
		settingName: "selectedContextFilterEnabled",
		settingType: e.Settings.SettingType.BOOLEAN,
		defaultValue: !1,
		options: [
			{ value: !0, title: i(s.onlyShowMessagesFromTheCurrent) },
			{ value: !1, title: i(s.showMessagesFromAllContexts) },
		],
	}),
	e.Settings.registerSettingExtension({
		category: e.Settings.SettingCategory.CONSOLE,
		storageType: e.Settings.SettingStorageType.Synced,
		title: i(s.logXmlhttprequests),
	...
	e.Settings.registerSettingExtension({
		category: e.Settings.SettingCategory.CONSOLE,
		storageType: e.Settings.SettingStorageType.Synced,
		title: i(s.showTimestamps),
		settingName: "consoleTimestampsEnabled",
		settingType: e.Settings.SettingType.BOOLEAN,
		defaultValue: !1,
		options: [
			{ value: !0, title: i(s.showTimestamps) },
			{ value: !1, title: i(s.hideTimestamps) },
		],
	}),
	e.Settings.registerSettingExtension({
		category: e.Settings.SettingCategory.CONSOLE,
		title: i(s.autocompleteFromHistory),
		settingName: "consoleHistoryAutocomplete",
		settingType: e.Settings.SettingType.BOOLEAN,
		defaultValue: !0,
		options: [
			{ value: !0, title: i(s.autocompleteFromHistory) },
			{ value: !1, title: i(s.doNotAutocompleteFromHistory) },
		],
	}),
	e.Settings.registerSettingExtension({
		category: e.Settings.SettingCategory.CONSOLE,
		storageType: e.Settings.SettingStorageType.Synced,
		title: i(s.autocompleteOnEnter),
		settingName: "consoleAutocompleteOnEnter",
		settingType: e.Settings.SettingType.BOOLEAN,
		defaultValue: !1,
		options: [
			{ value: !0, title: i(s.autocompleteOnEnter) },
			{ value: !1, title: i(s.doNotAutocompleteOnEnter) },
		],
	}),
	e.Settings.registerSettingExtension({
		category: e.Settings.SettingCategory.CONSOLE,
		storageType: e.Settings.SettingStorageType.Synced,
		title: i(s.groupSimilarMessagesInConsole),
		settingName: "consoleGroupSimilar",
		settingType: e.Settings.SettingType.BOOLEAN,
		defaultValue: !0,
		options: [
			{ value: !0, title: i(s.groupSimilarMessagesInConsole) },
			{ value: !1, title: i(s.doNotGroupSimilarMessagesIn) },
		],
	}),
	e.Settings.registerSettingExtension({
		category: e.Settings.SettingCategory.CONSOLE,
		title: i(s.showCorsErrorsInConsole),
		settingName: "consoleShowsCorsErrors",
		settingType: e.Settings.SettingType.BOOLEAN,
		defaultValue: !0,
		options: [
			{ value: !0, title: i(s.showCorsErrorsInConsole) },
			{ value: !1, title: i(s.doNotShowCorsErrorsIn) },
		],
	}),
	e.Settings.registerSettingExtension({
		category: e.Settings.SettingCategory.CONSOLE,
		storageType: e.Settings.SettingStorageType.Synced,
		title: i(s.eagerEvaluation),
		settingName: "consoleEagerEval",
		settingType: e.Settings.SettingType.BOOLEAN,
		defaultValue: !0,
		options: [
			{ value: !0, title: i(s.eagerlyEvaluateConsolePromptText) },
			{ value: !1, title: i(s.doNotEagerlyEvaluateConsole) },
		],
	}),
	e.Settings.registerSettingExtension({
		category: e.Settings.SettingCategory.CONSOLE,
		storageType: e.Settings.SettingStorageType.Synced,
		title: i(s.evaluateTriggersUserActivation),
		settingName: "consoleUserActivationEval",
		settingType: e.Settings.SettingType.BOOLEAN,
		defaultValue: !0,
		options: [
			{ value: !0, title: i(s.treatEvaluationAsUserActivation) },
			{ value: !1, title: i(s.doNotTreatEvaluationAsUser) },
		],
	}),
	e.Settings.registerSettingExtension({
		category: e.Settings.SettingCategory.CONSOLE,
		storageType: e.Settings.SettingStorageType.Synced,
		title: i(s.expandConsoleTraceMessagesByDefault),
		settingName: "consoleTraceExpand",
		settingType: e.Settings.SettingType.BOOLEAN,
		defaultValue: !0,
		options: [
			{ value: !0, title: i(s.expandConsoleTraceMessagesByDefault) },
			{ value: !1, title: i(s.collapseConsoleTraceMessagesByDefault) },
		],
	}),
	e.Revealer.registerRevealer({
		contextTypes: () => [e.Console.Console],
		destination: void 0,
		loadRevealer: async () => new (await r()).ConsolePanel.ConsoleRevealer(),
	}));
