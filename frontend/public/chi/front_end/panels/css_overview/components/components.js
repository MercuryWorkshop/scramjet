...
import * as o from "../../../ui/components/panel_feedback/panel_feedback.js";
import * as r from "../../../ui/components/panel_introduction_steps/panel_introduction_steps.js";
...
const n = {
		...
		locateAffectedElements:
			"Locate the affected elements in the Elements panel",
		quickStartWithCSSOverview:
			"Quick start: get started with the new CSS overview panel",
	},
	c = e.i18n.registerUIStrings(
		"panels/css_overview/components/CSSOverviewStartView.ts",
		n
	),
	l = e.i18n.getLocalizedString.bind(void 0, c),
	{ render: p, html: d } = i,
	v = "https://g.co/devtools/css-overview-feedback";
...
class u extends HTMLElement {
	static litTagName = i.literal`devtools-css-overview-start-view`;
	#e = this.attachShadow({ mode: "open" });
	connectedCallback() {
		((this.#e.adoptedStyleSheets = [a]), this.#t());
	}
	show() {
    ...
    `,
		...
		const e = this.#e.querySelector(".start-capture");
		e && e.focus();
	}
}
s.CustomElements.defineComponent("devtools-css-overview-start-view", u);
var h = Object.freeze({
	__proto__: null,
	OverviewStartRequestedEvent: m,
	CSSOverviewStartView: u,
});
export { h as CSSOverviewStartView };
