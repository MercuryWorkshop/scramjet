...
import * as o from "../../../ui/components/helpers/helpers.js";
import * as r from "../../../ui/components/render_coordinator/render_coordinator.js";
import * as n from "../../../ui/lit-html/lit-html.js";
...
import * as l from "../../../ui/components/icon_button/icon_button.js";
import * as c from "../../../ui/components/node_text/node_text.js";
import * as d from "../../../core/sdk/sdk.js";
import * as p from "../../../ui/components/legacy_wrapper/legacy_wrapper.js";
...
const g = { ignored: "Ignored" },
	m = e.i18n.registerUIStrings(
		"panels/elements/components/AccessibilityTreeNode.ts",
		g
	),
	y = e.i18n.getLocalizedString.bind(void 0, m);
class v extends HTMLElement {
	static litTagName = n.literal`devtools-accessibility-tree-node`;
	...
	connectedCallback() {
		this.#e.adoptedStyleSheets = [h];
	}
	async #i() {
		const e = n.html`<span class='role-value'>${((o = this.#r), o.length > 1e4 ? t.StringUtilities.trimMiddle(o, 1e4) : o)}</span>`;
		var o;
		const s = n.html`"<span class='attribute-value'>${this.#o}</span>"`,
			i = this.#n.map(({ name: e, value: t }) =>
				(function (e) {
					switch (e) {
						case "boolean":
					...
					? n.html` <span class='attribute-name'>${e}</span>:&nbsp;<span class='attribute-value'>${t.value}</span>`
					: n.nothing
			),
			a = this.#t
				? n.html`<span>${y(g.ignored)}</span>`
				: n.html`${e}&nbsp;${s}${i}`;
		await r.RenderCoordinator.RenderCoordinator.instance().write(
			`Accessibility node ${this.#s} render`,
			() => {
				n.render(n.html`<div class='container'>${a}</div>`, this.#e, {
					host: this,
				});
			}
		);
...
o.CustomElements.defineComponent("devtools-accessibility-tree-node", v);
var f,
	b = Object.freeze({ __proto__: null, AccessibilityTreeNode: v });
function x(e) {
	switch (e) {
		case f.GRID:
			return { name: "grid", category: "Layout", enabledByDefault: !0 };
		case f.SUBGRID:
			return { name: "subgrid", category: "Layout", enabledByDefault: !0 };
		case f.FLEX:
			return { name: "flex", category: "Layout", enabledByDefault: !0 };
		case f.AD:
			return { name: "ad", category: "Security", enabledByDefault: !0 };
		case f.SCROLL_SNAP:
			return { name: "scroll-snap", category: "Layout", enabledByDefault: !0 };
		case f.CONTAINER:
			return { name: "container", category: "Layout", enabledByDefault: !0 };
		case f.SLOT:
			return { name: "slot", category: "Layout", enabledByDefault: !0 };
		case f.TOP_LAYER:
			return { name: "top-layer", category: "Layout", enabledByDefault: !0 };
		case f.REVEAL:
			return { name: "reveal", category: "Default", enabledByDefault: !0 };
		case f.MEDIA:
			return { name: "media", category: "Default", enabledByDefault: !1 };
	}
}
let w;
function S(e) {
	if (!w) {
		w = new Map();
		for (const { name: e, category: t } of Object.values(f).map(x)) w.set(e, t);
	}
	return w.get(e) || "Default";
}
!(function (e) {
	((e.GRID = "grid"),
		(e.SUBGRID = "subgrid"),
		(e.FLEX = "flex"),
		(e.AD = "ad"),
		(e.SCROLL_SNAP = "scroll-snap"),
		(e.CONTAINER = "container"),
		(e.SLOT = "slot"),
		(e.TOP_LAYER = "top-layer"),
		(e.REVEAL = "reveal"),
		(e.MEDIA = "media"));
})(f || (f = {}));
const k = Object.values(f)
	.map(x)
	.map(({ name: e, enabledByDefault: t }) => ({ adorner: e, isEnabled: t }));
const T = new Map(["Security", "Layout", "Default"].map((e, t) => [e, t + 1]));
var O = Object.freeze({
	__proto__: null,
	get RegisteredAdorners() {
		return f;
	},
	getRegisteredAdorner: x,
	DefaultAdornerSettings: k,
	AdornerManager: class {
		...
		#d() {
			const e = [];
			for (const [t, o] of this.#a) e.push({ adorner: t, isEnabled: o });
			this.#l.set(e);
		}
		#p() {
			const e = this.#l.get();
			for (const t of e) this.#a.set(t.adorner, t.isEnabled);
		}
		#c() {
			this.#p();
			const e = new Set(this.#a.keys());
			for (const { adorner: t, isEnabled: o } of k)
				(e.delete(t), this.#a.has(t) || this.#a.set(t, o));
			for (const t of e) this.#a.delete(t);
			this.#d();
		}
	},
	AdornerCategoryOrder: T,
	compareAdornerNamesByCategory: function (e, t) {
		return (
			(T.get(S(e)) || Number.POSITIVE_INFINITY) -
			(T.get(S(t)) || Number.POSITIVE_INFINITY)
		);
	},
});
const N = new CSSStyleSheet();
N.replaceSync(
	'.adorner-settings-pane{display:flex;height:auto;padding:6px 12px;color:var(--sys-color-on-surface);font-size:12px;align-items:center}.settings-title{font-weight:500;margin-right:6px}.setting{margin-left:1em}.adorner-status{margin:auto 0.4em auto 0}.adorner-status,\n.adorner-name{vertical-align:middle}.close{position:relative;margin-left:auto;font-size:1em;width:1.5em;height:1.5em;border:none;border-radius:50%;background-color:var(--sys-color-cdt-base-container)}.close::before,\n.close::after{content:"";display:inline-block;position:absolute;left:0;right:0;top:0;bottom:0;margin:auto;width:1em;height:0.2em;background-color:var(--sys-color-token-subtle);border-radius:2px}.close:hover,\n.close:focus{background-color:var(--sys-color-state-hover-on-subtle)}.close::before{transform:rotate(45deg)}.close::after{transform:rotate(-45deg)}\n/*# sourceURL=adornerSettingsPane.css */\n'
);
const C = { settingsTitle: "Show badges", closeButton: "Close" },
	$ = e.i18n.registerUIStrings(
		"panels/elements/components/AdornerSettingsPane.ts",
		C
	),
	E = e.i18n.getLocalizedString.bind(void 0, $),
	{ render: M, html: _ } = n;
class L extends Event {
	...
	constructor(e, t, o) {
		(super(L.eventName, {}),
			(this.data = { adornerName: e, isEnabledNow: t, newSettings: o }));
	}
}
class z extends HTMLElement {
	static litTagName = n.literal`devtools-adorner-settings-pane`;
	#e = this.attachShadow({ mode: "open" });
	#u = new Map();
	connectedCallback() {
		this.#e.adoptedStyleSheets = [s.checkboxStyles, N];
	}
	set data(e) {
		((this.#u = new Map(e.settings.entries())), this.#i());
	}
	show() {
		this.classList.remove("hidden");
		const e = this.#e.querySelector(".adorner-settings-pane");
		e && e.focus();
	}
	hide() {
	...
	#h(e) {
		...
		if (void 0 === o) return;
		const r = t.checked;
		(this.#u.set(o, r), this.dispatchEvent(new L(o, r, this.#u)), this.#i());
	}
	#i() {
		const e = [];
		for (const [t, o] of this.#u)
			e.push(_`
      ...
      <div class="adorner-settings-pane" tabindex="-1">
        <div class="settings-title">${E(C.settingsTitle)}</div>
        <div class="setting-list" @change=${this.#h}>
          ${e}
        </div>
        <button class="close" @click=${this.hide} aria-label=${E(C.closeButton)}></button>
      </div>
    `,
			this.#e,
			{ host: this }
...
o.CustomElements.defineComponent("devtools-adorner-settings-pane", z);
var D = Object.freeze({
	__proto__: null,
	AdornerSettingUpdatedEvent: L,
	AdornerSettingsPane: z,
});
...
class R extends HTMLElement {
	static litTagName = n.literal`devtools-computed-style-property`;
	#e = this.attachShadow({ mode: "open" });
	#g = !1;
	#m = !1;
	connectedCallback() {
		((this.#e.adoptedStyleSheets = [P]), this.#i());
	}
	set inherited(e) {
		e !== this.#g && ((this.#g = e), this.#i());
	}
	set traceable(e) {
		e !== this.#m && ((this.#m = e), this.#i());
	}
	#y() {
	...
	#i() {
      ...
      <div class="computed-style-property ${this.#g ? "inherited" : ""}">
        ...
        ${this.#m ? j`<span class="goto" @click=${this.#y} jslog=${i.jumpToSource().track({ click: !0 })}></span>` : null}
...
o.CustomElements.defineComponent("devtools-computed-style-property", R);
var B = Object.freeze({
	__proto__: null,
	NavigateToSourceEvent: H,
	ComputedStyleProperty: R,
});
...
const { render: A, html: q } = n;
class V extends HTMLElement {
	static litTagName = n.literal`devtools-computed-style-trace`;
	#e = this.attachShadow({ mode: "open" });
	#v = "";
	#f = !1;
	#b = () => {};
	#x;
	connectedCallback() {
		this.#e.adoptedStyleSheets = [F];
	}
	set data(e) {
		((this.#v = e.selector),
			(this.#f = e.active),
			(this.#b = e.onNavigateToSource),
			(this.#x = e.ruleOriginNode),
			this.#i());
	}
	#i() {
		A(
...
o.CustomElements.defineComponent("devtools-computed-style-trace", V);
var G = Object.freeze({ __proto__: null, ComputedStyleTrace: V });
...
const W = { learnMore: "Learn More" },
	Q = e.i18n.registerUIStrings(
		"panels/elements/components/CSSHintDetailsView.ts",
		W
	),
	Y = e.i18n.getLocalizedString.bind(void 0, Q),
	{ render: X, html: K, Directives: J } = n;
class Z extends HTMLElement {
	static litTagName = n.literal`devtools-css-hint-details-view`;
	#e = this.attachShadow({ mode: "open" });
	#w;
	constructor(e) {
		(super(), (this.#w = e), (this.#e.adoptedStyleSheets = [U]), this.#i());
	}
	#i() {
		const e = this.#w.getLearnMoreLink();
		X(
			K`
        <div class="hint-popup-wrapper">
          <div class="hint-popup-reason">
            ${J.unsafeHTML(this.#w.getMessage())}
          </div>
          ${
						this.#w.getPossibleFixMessage()
							? K`
              <div class="hint-popup-possible-fix">
                  ${J.unsafeHTML(this.#w.getPossibleFixMessage())}
                  ${
										e
											? K`
...
o.CustomElements.defineComponent("devtools-css-hint-details-view", Z);
var ee = Object.freeze({ __proto__: null, CSSHintDetailsView: Z });
...
const oe = { learnMore: "Learn more", dontShow: "Don't show" },
	re = e.i18n.registerUIStrings(
		"panels/elements/components/CSSPropertyDocsView.ts",
		oe
	),
	ne = e.i18n.getLocalizedString.bind(void 0, re),
	{ render: se, html: ie } = n;
class ae extends HTMLElement {
	static litTagName = n.literal`devtools-css-property-docs-view`;
	#e = this.attachShadow({ mode: "open" });
	#S;
	constructor(e) {
		(super(),
			(this.#S = e),
			(this.#e.adoptedStyleSheets = [s.checkboxStyles, te]),
			this.#i());
	}
	#k(e) {
		const t = !e.target.checked;
		a.Settings.Settings.instance()
			.moduleSetting("showCSSPropertyDocumentationOnHover")
			.set(t);
	}
	#i() {
		const e = this.#S.description,
			t = this.#S.references?.[0].url;
		se(
			ie`
...
o.CustomElements.defineComponent("devtools-css-property-docs-view", ae);
var le = Object.freeze({ __proto__: null, CSSPropertyDocsView: ae });
const ce = new Set(["tb", "tb-rl", "vertical-lr", "vertical-rl"]);
var de;
function pe(e) {
	if (e === de.LEFT_TO_RIGHT) return de.RIGHT_TO_LEFT;
	if (e === de.RIGHT_TO_LEFT) return de.LEFT_TO_RIGHT;
	if (e === de.TOP_TO_BOTTOM) return de.BOTTOM_TO_TOP;
	if (e === de.BOTTOM_TO_TOP) return de.TOP_TO_BOTTOM;
	throw new Error("Unknown PhysicalFlexDirection");
}
function ue(e) {
	return { ...e, "row-reverse": pe(e.row), "column-reverse": pe(e.column) };
}
function he(e) {
	const t = "rtl" === e.get("direction"),
		o = e.get("writing-mode");
	return ue(
		o && ce.has(o)
			? {
					row: t ? de.BOTTOM_TO_TOP : de.TOP_TO_BOTTOM,
					column: "vertical-lr" === o ? de.LEFT_TO_RIGHT : de.RIGHT_TO_LEFT,
				}
			: {
					row: t ? de.RIGHT_TO_LEFT : de.LEFT_TO_RIGHT,
					column: de.TOP_TO_BOTTOM,
				}
	);
}
function ge(e) {
	...
	return (
		e === de.RIGHT_TO_LEFT
			...
			: e === de.TOP_TO_BOTTOM
				? ((r = 0), (t = !1), (o = !1))
				: e === de.BOTTOM_TO_TOP && ((r = 0), (t = !1), (o = !0)),
		{
...
function me(e, t) {
	return {
		iconName: e,
		rotate: t === de.RIGHT_TO_LEFT ? 90 : t === de.LEFT_TO_RIGHT ? -90 : 0,
		scaleX: 1,
		scaleY: 1,
	};
}
function ye(e, t) {
	return {
		iconName: e,
		rotate: t === de.TOP_TO_BOTTOM ? 90 : t === de.BOTTOM_TO_TOP ? -90 : 0,
		scaleX: t === de.RIGHT_TO_LEFT ? -1 : 1,
		scaleY: 1,
	};
}
function ve(e, t) {
	...
	return function (t) {
		const o = he(t),
			r = new Map([
				["column", o.row],
				["row", o.column],
				["column-reverse", o.row],
				["row-reverse", o.column],
			]),
			n = t.get("flex-direction") || "row",
			s = r.get(n);
		if (!s) throw new Error("Unknown direction for flex-align icon");
		return me(e, s);
	};
}
function we(e) {
	return function (t) {
		const o = he(t);
		return me(e, o.column);
	};
}
function Se(e) {
	return function (t) {
		const o = he(t);
		return ye(e, o[t.get("flex-direction") || "row"]);
	};
}
function ke(e) {
	return function (t) {
...
function Me(e, t) {
	return {
		iconName: e,
		rotate: t === de.BOTTOM_TO_TOP || t === de.TOP_TO_BOTTOM ? 90 : 0,
		scaleX: 1,
		scaleY: 1,
	};
}
...
const Le = new Map([
		["flex-direction: row", be("row")],
		["flex-direction: column", be("column")],
		["flex-direction: column-reverse", be("column-reverse")],
		["flex-direction: row-reverse", be("row-reverse")],
		["flex-direction: initial", be("row")],
		["flex-direction: unset", be("row")],
		["flex-direction: revert", be("row")],
		["align-content: center", xe("align-content-center")],
		["align-content: space-around", xe("align-content-space-around")],
		["align-content: space-between", xe("align-content-space-between")],
		["align-content: stretch", xe("align-content-stretch")],
		["align-content: space-evenly", xe("align-content-space-evenly")],
		["align-content: flex-end", xe("align-content-end")],
		["align-content: flex-start", xe("align-content-start")],
		["align-content: start", xe("align-content-start")],
		["align-content: end", xe("align-content-end")],
		["align-content: normal", xe("align-content-stretch")],
		["align-content: revert", xe("align-content-stretch")],
		["align-content: unset", xe("align-content-stretch")],
		["align-content: initial", xe("align-content-stretch")],
		["justify-content: center", Se("justify-content-center")],
		["justify-content: space-around", Se("justify-content-space-around")],
		["justify-content: space-between", Se("justify-content-space-between")],
		["justify-content: space-evenly", Se("justify-content-space-evenly")],
		["justify-content: flex-end", Se("justify-content-end")],
		["justify-content: flex-start", Se("justify-content-start")],
		["align-items: stretch", Oe("align-items-stretch")],
		["align-items: flex-end", Oe("align-items-end")],
		["align-items: flex-start", Oe("align-items-start")],
		["align-items: center", Oe("align-items-center")],
		["align-items: baseline", Ce],
		["align-content: baseline", Ce],
		["flex-wrap: wrap", _e("flex-wrap")],
		["flex-wrap: nowrap", _e("flex-no-wrap")],
	]),
	ze = new Map([
		["align-self: baseline", Ce],
		["align-self: center", $e("align-self-center")],
		["align-self: flex-start", $e("align-self-start")],
		["align-self: flex-end", $e("align-self-end")],
		["align-self: stretch", $e("align-self-stretch")],
	]),
	De = new Map([
		["align-content: center", we("align-content-center")],
		["align-content: space-around", we("align-content-space-around")],
		["align-content: space-between", we("align-content-space-between")],
		["align-content: stretch", we("align-content-stretch")],
		["align-content: space-evenly", we("align-content-space-evenly")],
		["align-content: end", we("align-content-end")],
		["align-content: start", we("align-content-start")],
		["align-content: baseline", Ce],
		["justify-content: center", ke("justify-content-center")],
		["justify-content: space-around", ke("justify-content-space-around")],
		["justify-content: space-between", ke("justify-content-space-between")],
		["justify-content: space-evenly", ke("justify-content-space-evenly")],
		["justify-content: end", ke("justify-content-end")],
		["justify-content: start", ke("justify-content-start")],
		["align-items: stretch", Ne("align-items-stretch")],
		["align-items: end", Ne("align-items-end")],
		["align-items: start", Ne("align-items-start")],
		["align-items: center", Ne("align-items-center")],
		["align-items: baseline", Ce],
		["justify-items: center", Te("justify-items-center")],
		["justify-items: stretch", Te("justify-items-stretch")],
		["justify-items: end", Te("justify-items-end")],
		["justify-items: start", Te("justify-items-start")],
		["justify-items: baseline", Ce],
	]),
	Pe = new Map([
		["align-self: baseline", Ce],
		["align-self: center", Ee("align-self-center")],
		["align-self: start", Ee("align-self-start")],
		["align-self: end", Ee("align-self-end")],
		["align-self: stretch", Ee("align-self-stretch")],
	]),
	Ie = (e) => {
...
function He(e, t) {
	const o = Le.get(e);
	return o ? o(t || new Map()) : null;
}
function Re(e, t, o) {
	const r = ze.get(e);
	return r ? r(t || new Map(), o || new Map()) : null;
}
function Be(e, t) {
	const o = De.get(e);
	return o ? o(t || new Map()) : null;
...
var Ae = Object.freeze({
	__proto__: null,
	get PhysicalDirection() {
		return de;
	},
	reverseDirection: pe,
	getPhysicalDirections: he,
	rotateFlexDirectionIcon: ge,
	rotateAlignContentIcon: me,
	rotateJustifyContentIcon: ye,
	rotateJustifyItemsIcon: ve,
	rotateAlignItemsIcon: fe,
	roateFlexWrapIcon: Me,
	findIcon: function (e, t, o) {
		if (Ie(t)) {
			const o = He(e, t);
			if (o) return o;
		}
	...
	findFlexContainerIcon: He,
	findFlexItemIcon: Re,
	findGridContainerIcon: Be,
	findGridItemIcon: Fe,
});
...
const { render: Ge, html: Ue } = n;
class We extends HTMLElement {
	static litTagName = n.literal`devtools-css-query`;
	#e = this.attachShadow({ mode: "open" });
	#T = "";
	#O;
	#N = "";
	#C;
	set data(e) {
		((this.#T = e.queryPrefix),
			(this.#O = e.queryName),
			(this.#N = e.queryText),
			(this.#C = e.onQueryTextClick),
			this.#i());
	}
	connectedCallback() {
		this.#e.adoptedStyleSheets = [Ve, qe];
	}
	#i() {
		const e = n.Directives.classMap({ query: !0, editable: Boolean(this.#C) }),
			t = Ue`
      <span class="query-text" @click=${this.#C}>${this.#N}</span>
    `;
		Ge(
			Ue`
      <div class=${e}>
        ${this.#T ? Ue`<span>${this.#T + " "}</span>` : n.nothing}${this.#O ? Ue`<span>${this.#O + " "}</span>` : n.nothing}${t}
      </div>
    `,
			this.#e,
			{ host: this }
...
o.CustomElements.defineComponent("devtools-css-query", We);
var Qe = Object.freeze({ __proto__: null, CSSQuery: We });
...
const Xe = {
	...
	Ke = e.i18n.registerUIStrings(
		"panels/elements/components/CSSVariableValueView.ts",
		Xe
	),
	Je = e.i18n.getLocalizedString.bind(void 0, Ke),
	Ze = n.i18nTemplate.bind(void 0, Ke),
	{ render: et, html: tt } = n;
function ot(e) {
	return tt`<div class="registered-property-links">
...
class rt extends HTMLElement {
	static litTagName = n.literal`devtools-css-variable-parser-error`;
	#e = this.attachShadow({ mode: "open" });
	constructor(e) {
		(super(), (this.#e.adoptedStyleSheets = [Ye]), this.#i(e));
	}
	#i(e) {
		const t = tt`<span class="monospace css-property">${e.registration.syntax()}</span>`;
		et(
			tt`
...
class nt extends HTMLElement {
	static litTagName = n.literal`devtools-css-variable-value-view`;
	#e = this.attachShadow({ mode: "open" });
	variableName;
	value;
	details;
	constructor({ variableName: e, value: t, details: o }) {
		(super(),
	...
	#i() {
		const e = this.details?.registration.initialValue(),
			t = this.details
				? tt`
        <hr class=divider />
        <div class=registered-property-popup-wrapper>
          ...
          ${ot(this.details)}
				...
				: "",
			o = this.value ?? Je(Xe.sIsNotDefined, { PH1: this.variableName });
		et(
			tt`<div class="variable-value-popup-wrapper">
               ${o}
             </div>
             ${t}
             `,
...
(o.CustomElements.defineComponent("devtools-css-variable-value-view", nt),
	o.CustomElements.defineComponent("devtools-css-variable-parser-error", rt));
var st = Object.freeze({
	__proto__: null,
	CSSVariableParserError: rt,
	CSSVariableValueView: nt,
});
...
const at = { text: "(text)" },
	lt = e.i18n.registerUIStrings(
		"panels/elements/components/ElementsBreadcrumbsUtils.ts",
		at
	),
	ct = e.i18n.getLocalizedString.bind(void 0, lt),
	dt = (e, t) =>
		t
			? e
					.filter((e) => e.nodeType !== Node.DOCUMENT_NODE)
					.map((e) => ({
						title: ut(e),
						selected: e.id === t.id,
						node: e,
						originalNode: e.legacyDomNode,
					}))
					.reverse()
			: [],
	pt = (e, t = {}) => ({ main: e, extras: t }),
	ut = (e) => {
		switch (e.nodeType) {
			case Node.ELEMENT_NODE: {
				if (e.pseudoType) return pt("::" + e.pseudoType);
				const t = pt(e.nodeNameNicelyCased),
					o = e.getAttribute("id");
				o && (t.extras.id = o);
				const r = e.getAttribute("class");
				if (r) {
					const e = new Set(r.split(/\s+/));
					t.extras.classes = Array.from(e);
				}
				return t;
			}
			case Node.TEXT_NODE:
				return pt(ct(at.text));
			case Node.COMMENT_NODE:
				return pt("\x3c!--\x3e");
			case Node.DOCUMENT_TYPE_NODE:
				return pt("<!doctype>");
			case Node.DOCUMENT_FRAGMENT_NODE:
				return pt(e.shadowRootType ? "#shadow-root" : e.nodeNameNicelyCased);
			default:
				return pt(e.nodeNameNicelyCased);
		}
	};
var ht = Object.freeze({
	__proto__: null,
	crumbsToRender: dt,
	determineElementTitle: ut,
});
const gt = {
	...
	mt = e.i18n.registerUIStrings(
		"panels/elements/components/ElementsBreadcrumbs.ts",
		gt
	),
	yt = e.i18n.getLocalizedString.bind(void 0, mt);
class vt extends Event {
	static eventName = "breadcrumbsnodeselected";
	legacyDomNode;
	constructor(e) {
		(super(vt.eventName, {}), (this.legacyDomNode = e.legacyDomNode));
	}
}
const ft = r.RenderCoordinator.RenderCoordinator.instance();
class bt extends HTMLElement {
	static litTagName = n.literal`devtools-elements-breadcrumbs`;
	#e = this.attachShadow({ mode: "open" });
	#$ = new ResizeObserver(() => this.#E());
	#M = this.#i.bind(this);
	#_ = [];
	#L = null;
	#z = !1;
	...
	#I = !1;
	connectedCallback() {
		this.#e.adoptedStyleSheets = [it];
	}
	set data(e) {
		((this.#L = e.selectedNode),
			(this.#_ = e.crumbs),
			(this.#I = !1),
			o.ScheduledRender.scheduleRender(this, this.#M));
	}
	disconnectedCallback() {
		((this.#P = !1), this.#$.disconnect());
	}
	#j(e) {
		return (t) => {
			(t.preventDefault(), this.dispatchEvent(new vt(e)));
		};
	}
	async #E() {
		const e = this.#e.querySelector(".crumbs-scroll-container"),
			t = this.#e.querySelector(".crumbs-window");
		if (!e || !t) return;
		const o = await ft.read(() => t.clientWidth),
			r = await ft.read(() => e.clientWidth);
		(this.#z ? r < o && (this.#z = !1) : r > o && (this.#z = !0),
			this.#H(),
			this.#R(t));
	}
	#B(e) {
	...
	#V() {
		if (!this.#$ || !0 === this.#P) return;
		const e = this.#e.querySelector(".crumbs");
		e && (this.#$.observe(e), (this.#P = !0));
	}
	async #G() {
		const e = this.#e.querySelector(".crumbs-scroll-container"),
			t = this.#e.querySelector(".crumbs-window");
	...
	#R(e) {
		const t = e.scrollWidth - e.clientWidth,
			o = e.scrollLeft;
		((this.#D = o < 10 ? "start" : o >= t - 10 ? "end" : "middle"), this.#i());
	}
	#W(e) {
		return () => {
			this.#I = !0;
			const t = this.#e.querySelector(".crumbs-window");
			if (!t) return;
			const o = t.clientWidth / 2,
				r =
					"left" === e
						? Math.max(Math.floor(t.scrollLeft - o), 0)
						: t.scrollLeft + o;
			t.scrollTo({ behavior: "smooth", left: r });
		};
	}
	#Q(e, t) {
		const o = n.Directives.classMap({
				overflow: !0,
				[e]: !0,
				hidden: !this.#z,
			}),
			r = yt("left" === e ? gt.scrollLeft : gt.scrollRight);
		return n.html`
      <button
        class=${o}
        @click=${this.#W(e)}
        ...
        aria-label=${r}
        title=${r}>
        <${l.Icon.Icon.litTagName} .data=${{ iconName: "triangle-" + e, color: "var(--sys-color-on-surface)", width: "12px", height: "10px" }}>
        </${l.Icon.Icon.litTagName}>
      </button>
      `;
	}
	#i() {
		const e = dt(this.#_, this.#L);
		(n.render(
			n.html`
      <nav class="crumbs" aria-label=${yt(gt.breadcrumbs)} jslog=${i.elementsBreadcrumbs()}>
        ${this.#Q("left", "start" === this.#D)}

        <div class="crumbs-window" @scroll=${this.#U}>
          <ul class="crumbs-scroll-container">
            ${e.map((e) => {
							const t = { crumb: !0, selected: e.selected };
							return n.html`
                ...
                >
                  <a href="#"
                    ...
                    @click=${this.#j(e.node)}
                    @mousemove=${this.#B(e.node)}
                    @mouseleave=${this.#F(e.node)}
                    @focus=${this.#A(e.node)}
                    @blur=${this.#q(e.node)}
                  ><${c.NodeText.NodeText.litTagName} data-node-title=${e.title.main} .data=${{ nodeTitle: e.title.main, nodeId: e.title.extras.id, nodeClasses: e.title.extras.classes }}></${c.NodeText.NodeText.litTagName}></a>
                </li>`;
						})}
          </ul>
        </div>
        ${this.#Q("right", "end" === this.#D)}
      </nav>
    `,
			this.#e,
			{ host: this }
	...
	async #H() {
		if (!this.#L || !this.#e || !this.#z || this.#I) return;
		const e = this.#L.id,
			t = this.#e.querySelector(`.crumb[data-node-id="${e}"]`);
		t &&
			(await ft.scroll(() => {
...
o.CustomElements.defineComponent("devtools-elements-breadcrumbs", bt);
var xt = Object.freeze({
	__proto__: null,
	NodeSelectedEvent: vt,
	ElementsBreadcrumbs: bt,
});
...
const Ct = {
	...
	$t = e.i18n.registerUIStrings("panels/elements/components/LayoutPane.ts", Ct),
	Et = e.i18n.getLocalizedString.bind(void 0, $t),
	{ render: Mt, html: _t } = n,
	Lt = (e) => {
		...
		return {
			...
			name: e.localName(),
			domId: e.getAttribute("id"),
			domClasses: t ? t.split(/\s+/).filter((e) => Boolean(e)) : void 0,
			enabled: !1,
			reveal: () => {
				(a.Revealer.reveal(e), e.scrollIntoView());
			},
			highlight: () => {
				e.highlight();
			},
			hideHighlight: () => {
				d.OverlayModel.OverlayModel.hideDOMNodeHighlight();
			},
			toggle: (e) => {
	...
	zt = (e) =>
		e.map((e) => {
			...
			return {
				...t,
				color:
					e.domModel().overlayModel().colorOfGridInPersistentOverlay(o) ||
					"var(--sys-color-inverse-surface)",
				enabled: e
					.domModel()
					.overlayModel()
					.isHighlightedGridInPersistentOverlay(o),
				toggle: (t) => {
					t
						? e.domModel().overlayModel().highlightGridInPersistentOverlay(o)
						: e.domModel().overlayModel().hideGridInPersistentOverlay(o);
				},
				setColor(t) {
					((this.color = t),
						e
							.domModel()
							.overlayModel()
							.setColorOfGridInPersistentOverlay(o, t));
				},
			};
		}),
	Dt = (e) =>
		e.map((e) => {
			...
			return {
				...t,
				color:
					e.domModel().overlayModel().colorOfFlexInPersistentOverlay(o) ||
					"var(--sys-color-inverse-surface)",
				enabled: e
					.domModel()
					.overlayModel()
					.isHighlightedFlexContainerInPersistentOverlay(o),
				toggle: (t) => {
					t
						? e
								.domModel()
								.overlayModel()
								.highlightFlexContainerInPersistentOverlay(o)
						: e
								.domModel()
								.overlayModel()
								.hideFlexContainerInPersistentOverlay(o);
				},
				setColor(t) {
					((this.color = t),
						e
							.domModel()
							.overlayModel()
							.setColorOfFlexInPersistentOverlay(o, t));
				},
			};
		});
function Pt(e) {
	return e.type === a.Settings.SettingType.ENUM;
}
function It(e) {
	return e.type === a.Settings.SettingType.BOOLEAN;
}
const jt = r.RenderCoordinator.RenderCoordinator.instance();
let Ht;
class Rt extends p.LegacyWrapper.WrappableComponent {
	static litTagName = n.literal`devtools-layout-pane`;
	#e = this.attachShadow({ mode: "open" });
	#u = [];
	#K;
	#J;
	constructor() {
		(super(),
			(this.#u = this.#Z()),
			(this.#K =
				a.Settings.Settings.instance().moduleSetting("showUAShadowDOM")),
			(this.#J = []),
			(this.#e.adoptedStyleSheets = [s.checkboxStyles, Nt, qe]));
	}
	static instance() {
		return (
			Ht || (Ht = p.LegacyWrapper.legacyWrapper(u.Widget.Widget, new Rt())),
			(Ht.element.style.minWidth = "min-content"),
			Ht.getComponent()
		);
	}
	modelAdded(e) {
		const t = e.overlayModel();
		(t.addEventListener(
			d.OverlayModel.Events.PersistentGridOverlayStateChanged,
			this.render,
			this
		),
			t.addEventListener(
				d.OverlayModel.Events.PersistentFlexContainerOverlayStateChanged,
				this.render,
				this
			),
			this.#J.push(e));
	...
	async #ee(e) {
		...
		for (const r of this.#J)
			try {
				const n = await r.getNodesByStyle(e, !0);
				for (const e of n) {
					const n = r.nodeForId(e);
					null === n || (!t && n.ancestorUserAgentShadowRoot()) || o.push(n);
				}
			} catch (e) {
				console.warn(e);
			}
	...
	#Z() {
		...
		for (const t of [
			...
			const o = a.Settings.Settings.instance().moduleSetting(t),
				r = o.get(),
				n = o.type();
			if (!n)
				throw new Error(
					"A setting provided to LayoutSidebarPane does not have a setting type"
				);
			if (
				n !== a.Settings.SettingType.BOOLEAN &&
				n !== a.Settings.SettingType.ENUM
			)
				throw new Error(
					"A setting provided to LayoutSidebarPane does not have a supported setting type"
				);
			const s = { type: n, name: o.name, title: o.title() };
			("boolean" == typeof r || "string" == typeof r) &&
				e.push({
					...s,
					value: r,
					options: o.options().map((e) => ({ ...e, value: e.value })),
				});
		}
		return e;
	}
	onSettingChanged(e, t) {
		a.Settings.Settings.instance().moduleSetting(e).set(t);
	}
	wasShown() {
		...
		for (const e of this.#J) this.modelRemoved(e);
		((this.#J = []),
			d.TargetManager.TargetManager.instance().observeModels(
				d.DOMModel.DOMModel,
				this,
				{ scoped: !0 }
			),
			...
			this.#K.addChangeListener(this.render, this),
			this.render());
	}
	willHide() {
		for (const e of this.#u)
		...
		(d.TargetManager.TargetManager.instance().unobserveModels(
			d.DOMModel.DOMModel,
			this
		),
			...
			this.#K.removeChangeListener(this.render, this));
	}
	#re(e) {
		if (!e.target) return;
	...
	async render() {
		const e = zt(await this.#te()),
			t = Dt(await this.#oe());
		await jt.write("LayoutPane render", () => {
			Mt(
				_t`
        <details open>
          <summary class="header" @keydown=${this.#re}>
            ${Et(Ct.grid)}
          </summary>
          <div class="content-section" jslog=${i.gridSettings()}>
            <h3 class="content-section-title">${Et(Ct.overlayDisplaySettings)}</h3>
          ...
          ${
						e
							? _t`<div class="content-section" jslog=${i.gridOverlays()}>
              <h3 class="content-section-title">
                ${e.length ? Et(Ct.gridOverlays) : Et(Ct.noGridLayoutsFoundOnThisPage)}
              </h3>
              ${
								e.length
									? _t`<div class="elements">
                  ${e.map((e) => this.#le(e))}
                </div>`
									: ""
							}
        ...
        ${
          ...
          <details open>
            ...
            ${
							t
								? _t`<div class="content-section" jslog=${i.flexboxOverlays()}>
                <h3 class="content-section-title">
                  ${t.length ? Et(Ct.flexboxOverlays) : Et(Ct.noFlexboxLayoutsFoundOnThisPage)}
                </h3>
                ${
									t.length
										? _t`<div class="elements">
	...
	#ne() {
		return this.#u.filter(Pt);
	}
	#ie() {
		return this.#u.filter(It);
	}
	#ce(e, t) {
	...
	#he(e, t) {
		(t.preventDefault(), e.setColor(t.target.value), this.render());
	}
	#ge(e, t) {
	...
	#le(e) {
		const t = this.#pe.bind(this, e),
			o = this.#ue.bind(this, e),
			r = this.#he.bind(this, e),
			n = this.#ge.bind(this, e),
			s = this.#me.bind(this, e);
		return _t`<div class="element" jslog=${i.item()}>
      <label data-element="true" class="checkbox-label">
        ...
        <span class="node-text-container" data-label="true" @mouseenter=${n} @mouseleave=${s}>
          <${c.NodeText.NodeText.litTagName} .data=${{ nodeId: e.domId, nodeTitle: e.name, nodeClasses: e.domClasses }}></${c.NodeText.NodeText.litTagName}>
        </span>
      </label>
      <label @keyup=${(e) => {
				if ("Enter" !== e.key && " " !== e.key) return;
				(e.target.querySelector("input").click(),
					u.ARIAUtils.alert(Et(Ct.colorPickerOpened)),
					e.preventDefault());
			}} @keydown=${(e) => {
				" " === e.key && e.preventDefault();
			}} class="color-picker-label" style="background: ${e.color};" jslog=${i.showStyleEditor().track({ click: !0 }).context("color")}>
        <input @change=${r} @input=${r} title=${Et(Ct.chooseElementOverlayColor)} tabindex="0" class="color-picker" type="color" value=${e.color} />
      </label>
      <${l.Icon.Icon.litTagName} .data=${{ iconName: "select-element", color: "var(--icon-show-element)", width: "16px" }} tabindex="0", @click=${o} title=${Et(Ct.showElementInTheElementsPanel)} class="show-element" jslog=${i.jumpToElement().track({ click: !0 })}>
      ()
      </${l.Icon.Icon.litTagName}>
    </div>`;
	}
	#ae(e) {
		const t = this.#ce.bind(this, e);
		return _t`<label data-boolean-setting="true" class="checkbox-label" title=${e.title} jslog=${i.toggle().track({ click: !0 }).context(e.name)}>
      <input data-input="true" type="checkbox" .checked=${e.value} @change=${t} />
      <span data-label="true">${e.title}</span>
    </label>`;
	}
	#se(e) {
		const t = this.#de.bind(this, e);
		return _t`<label data-enum-setting="true" class="select-label" title=${e.title}>
      <select
        class="chrome-select"
        data-input="true"
        jslog=${i.dropDown().track({ change: !0 }).context(e.name)}
        @change=${t}>
        ${e.options.map((t) => _t`<option value=${t.value} .selected=${e.value === t.value}>${t.title}</option>`)}
      </select>
    </label>`;
	}
}
o.CustomElements.defineComponent("devtools-layout-pane", Rt);
var Bt = Object.freeze({ __proto__: null, LayoutPane: Rt }),
	Ft = Object.freeze({ __proto__: null });
...
const { render: qt, html: Vt } = n,
	{ PhysicalAxis: Gt, QueryAxis: Ut } = d.CSSContainerQuery;
...
class Qt extends HTMLElement {
	static litTagName = n.literal`devtools-query-container`;
	#e = this.attachShadow({ mode: "open" });
	#O;
	#ye;
	#ve;
	...
	set data(e) {
		((this.#O = e.queryName),
			(this.#ye = e.container),
			(this.#ve = e.onContainerLinkClick),
			this.#i());
	}
	connectedCallback() {
	...
	async #xe() {
		(this.#ye?.highlightNode("container-outline"),
			(this.#fe = !0),
			this.dispatchEvent(new Wt()));
	}
	#we() {
		(this.#ye?.clearHighlight(), (this.#fe = !1), this.#i());
	}
	#i() {
		if (!this.#ye) return;
		let e, t;
		this.#O ||
			((e = this.#ye.getAttribute("id")),
			(t = this.#ye.getAttribute("class")?.split(/\s+/).filter(Boolean)));
		const o = this.#O || this.#ye.nodeNameNicelyCased;
		qt(
			Vt`
      →
      <a href="#"
        ...
        @mouseenter=${this.#xe}
        @mouseleave=${this.#we}
      ><${c.NodeText.NodeText.litTagName}
          data-node-title=${o}
          .data=${{ nodeTitle: o, nodeId: e, nodeClasses: t }}></${c.NodeText.NodeText.litTagName}></a>
      ${this.#fe ? this.#Se() : n.nothing}
    `,
			this.#e,
			{ host: this }
		);
	...
	#Se() {
		if (!this.#be || "" === this.#be.queryAxis) return n.nothing;
		const e = "size" === this.#be.queryAxis,
			t = n.Directives.classMap({
				"axis-icon": !0,
				hidden: e,
				vertical: "Vertical" === this.#be.physicalAxis,
			});
		return Vt`
      <span class="queried-size-details">
        (${this.#be.queryAxis}<${l.Icon.Icon.litTagName}
          class=${t} .data=${{ iconName: "width", color: "var(--icon-default)" }}></${l.Icon.Icon.litTagName}>)
        ${e && this.#be.width ? "width:" : n.nothing}
        ${this.#be.width || n.nothing}
        ${e && this.#be.height ? "height:" : n.nothing}
        ${this.#be.height || n.nothing}
      </span>
    `;
	}
}
o.CustomElements.defineComponent("devtools-query-container", Qt);
var Yt = Object.freeze({
	__proto__: null,
	QueriedSizeRequestedEvent: Wt,
	QueryContainer: Qt,
});
...
const Kt = {
	...
	Jt = e.i18n.registerUIStrings(
		"panels/elements/components/StylePropertyEditor.ts",
		Kt
	),
	Zt = e.i18n.getLocalizedString.bind(void 0, Jt),
	{ render: eo, html: to, Directives: oo } = n;
class ro extends Event {
	static eventName = "propertyselected";
	data;
	constructor(e, t) {
		(super(ro.eventName, {}), (this.data = { name: e, value: t }));
	}
}
class no extends Event {
	static eventName = "propertydeselected";
	data;
	constructor(e, t) {
		(super(no.eventName, {}), (this.data = { name: e, value: t }));
	}
}
class so extends HTMLElement {
	...
	connectedCallback() {
		this.#e.adoptedStyleSheets = [Xt];
	}
	getEditableProperties() {
		return this.editableProperties;
	}
	set data(e) {
		((this.#ke = e.authoredProperties),
			(this.#Te = e.computedProperties),
			this.#i());
	}
	#i() {
		eo(
      ...
      <div class="container" jslog=${this.jslog}>
        ${this.editableProperties.map((e) => this.#Oe(e))}
      </div>
    `,
			this.#e,
			{ host: this }
	...
	#Oe(e) {
		const t = this.#ke.get(e.propertyName),
			o = !t,
			r = t || this.#Te.get(e.propertyName),
			n = oo.classMap({ "property-value": !0, "not-authored": o });
		return to`<div class="row">
      <div class="property">
        <span class="property-name">${e.propertyName}</span>: <span class=${n}>${r}</span>
      </div>
      <div class="buttons">
        ${e.propertyValues.map((o) => this.#Ne(o, e.propertyName, o === t))}
      </div>
    </div>`;
	}
	#Ne(e, t, o = !1) {
		const r = `${t}: ${e}`,
			n = this.findIcon(r, this.#Te);
		if (!n) throw new Error(`Icon for ${r} is not found`);
		const s = `transform: rotate(${n.rotate}deg) scale(${n.scaleX}, ${n.scaleY})`,
			a = oo.classMap({ button: !0, selected: o }),
			c = { propertyName: t, propertyValue: e },
			d = Zt(o ? Kt.deselectButton : Kt.selectButton, c);
		return to`
      <button title=${d}
              class=${a}
              jslog=${i.item().track({ click: !0 }).context(r)}
              @click=${() => this.#Ce(t, e, o)}>
        <${l.Icon.Icon.litTagName} style=${s} name=${n.iconName}>
        </${l.Icon.Icon.litTagName}>
      </button>
    `;
	}
	#Ce(e, t, o) {
		o ? this.dispatchEvent(new no(e, t)) : this.dispatchEvent(new ro(e, t));
	}
	findIcon(e, t) {
		throw new Error("Not implemented");
	}
...
class io extends so {
	jslog = `${i.cssFlexboxEditor()}`;
	editableProperties = lo;
	findIcon(e, t) {
		return He(e, t);
	}
}
o.CustomElements.defineComponent("devtools-flexbox-editor", io);
class ao extends so {
	jslog = `${i.cssGridEditor()}`;
	editableProperties = co;
	findIcon(e, t) {
		return Be(e, t);
	}
}
o.CustomElements.defineComponent("devtools-grid-editor", ao);
const lo = [
		{
...
var po = Object.freeze({
	__proto__: null,
	PropertySelectedEvent: ro,
	PropertyDeselectedEvent: no,
	StylePropertyEditor: so,
	FlexboxEditor: io,
	GridEditor: ao,
	FlexboxEditableProperties: lo,
	GridEditableProperties: co,
});
export {
	b as AccessibilityTreeNode,
	O as AdornerManager,
	D as AdornerSettingsPane,
	ee as CSSHintDetailsView,
	le as CSSPropertyDocsView,
	Ae as CSSPropertyIconResolver,
	Qe as CSSQuery,
	st as CSSVariableValueView,
	B as ComputedStyleProperty,
	G as ComputedStyleTrace,
	xt as ElementsBreadcrumbs,
	ht as ElementsBreadcrumbsUtils,
	kt as ElementsTreeExpandButton,
	Ot as Helper,
	Bt as LayoutPane,
	Ft as LayoutPaneUtils,
	Yt as QueryContainer,
	po as StylePropertyEditor,
};
