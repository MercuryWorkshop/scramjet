...
const i = {
	...
	e = t.i18n.registerUIStrings("panels/layer_viewer/layer_viewer-meta.ts", i),
	n = t.i18n.getLazilyComputedLocalizedString.bind(void 0, e);
(o.ActionRegistration.registerActionExtension({
	actionId: "layers.reset-view",
	category: o.ActionRegistration.ActionCategory.LAYERS,
	title: n(i.resetView),
	bindings: [{ shortcut: "0" }],
}),
	o.ActionRegistration.registerActionExtension({
		...
		category: o.ActionRegistration.ActionCategory.LAYERS,
		title: n(i.switchToPanMode),
		bindings: [{ shortcut: "x" }],
	}),
	o.ActionRegistration.registerActionExtension({
		actionId: "layers.rotate-mode",
		category: o.ActionRegistration.ActionCategory.LAYERS,
		title: n(i.switchToRotateMode),
		bindings: [{ shortcut: "v" }],
	}),
	o.ActionRegistration.registerActionExtension({
