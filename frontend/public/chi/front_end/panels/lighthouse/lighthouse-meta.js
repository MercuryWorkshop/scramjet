...
const t = { showLighthouse: "Show `Lighthouse`" },
	o = i.i18n.registerUIStrings("panels/lighthouse/lighthouse-meta.ts", t),
...
e.ViewManager.registerViewExtension({
	...
	commandPrompt: n(t.showLighthouse),
	order: 90,
	loadView: async () =>
		(
			await (async function () {
				return (s || (s = await import("./lighthouse.js")), s);
			})()
