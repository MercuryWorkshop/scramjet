...
const e = {
	...
	o = i.i18n.registerUIStrings(
		"panels/mobile_throttling/mobile_throttling-meta.ts",
		e
	),
	a = i.i18n.getLazilyComputedLocalizedString.bind(void 0, o);
let g;
async function r() {
	return (g || (g = await import("./mobile_throttling.js")), g);
}
(n.ViewManager.registerViewExtension({
	location: "settings-view",
	id: "throttling-conditions",
	title: a(e.throttling),
	commandPrompt: a(e.showThrottling),
	order: 35,
	loadView: async () =>
		new (await r()).ThrottlingSettingsTab.ThrottlingSettingsTab(),
	...
	n.ActionRegistration.registerActionExtension({
		...
		loadActionDelegate: async () =>
			new (await r()).ThrottlingManager.ActionDelegate(),
		tags: [a(e.device), a(e.throttlingTag)],
	}),
	n.ActionRegistration.registerActionExtension({
		actionId: "network-conditions.network-low-end-mobile",
		category: n.ActionRegistration.ActionCategory.NETWORK,
		title: a(e.enableSlowGThrottling),
		loadActionDelegate: async () =>
			new (await r()).ThrottlingManager.ActionDelegate(),
		tags: [a(e.device), a(e.throttlingTag)],
	}),
	n.ActionRegistration.registerActionExtension({
		...
		category: n.ActionRegistration.ActionCategory.NETWORK,
		title: a(e.enableFastGThrottling),
		loadActionDelegate: async () =>
			new (await r()).ThrottlingManager.ActionDelegate(),
		tags: [a(e.device), a(e.throttlingTag)],
	}),
